            ...
            <div class="overlay-hero pa"></div>
                ...
                <div class="row">
                    <div class="col-sm-8 mx-auto text-center">
                        <h1 class="hero-h1">Receive Personalized Daily Guidance And Direction To Truly Maximize The Purpose and Talents Of Your <?php if (empty($_GET['archetype'])) { echo "Archetype"; } else { echo ucwords($_GET['archetype'] . " " . 'Archetype'); };?></h1>
                        <h4 class="hero-h4">Everyday Can Be Abundant and Rewarding With These Daily Insights</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="sp-wrapper">
                        ...
                        <p>Ever got caught in a dilemma where whatever choice you make just doesn't feel right...?</p>
                        <p>...Maybe you weren't sure if a valuable opportunity was right for you, and the ship sailed before you had the chance to say "Yes!"</p>
                        <p>...Maybe someone you trusted whole-heartedly went ahead to stab you right in the back.</p>
                        <p>They say these painful lessons are part and parcel of life; <em>are they really?</em></p>
                        <p>See, these misfortunes are <strong>a product of misguided energies</strong> and uncertainty!</p>
                        <p>It all boils down to conventional wisdom - when we're not sure of something, or when we don't have enough information, we tend to make the wrong choice.</p>
                        <p>So how can we be sure of our choices if we aren't yet coompletely sure of ourselves?</p>
                        <p class="sp-title">Immense Personal Growth Through Personality-Focused Guidance</p>
                        <p><?php if (empty($_GET['name'])) { echo 'My dear'; } else { echo ucwords($_GET['name']); };?> - you've recently learned about the strengths, weaknesses, and talents of your magnificent <?php if (empty($_GET['archetype'])) { echo 'archetype'; } else { echo $_GET['archetype'] . ' ' . 'archetype'; };?>.</p>
                        <p>It's a start, and I'm sure you're aware that knowledge alone can only go so far.</p>
                        <p>See, to change any given situation, you need to translate that knowledge into the CORRECT response...</p>
                        <p>...A response that's supported by your <strong>personal interests, innate strengths, and lifelong purpose.</strong></p>
                        <p>All of that wonderful wisdom exists within your <?php if (empty($_GET['archetype'])) { echo 'archetype'; } else { echo $_GET['archetype'] . ' ' . 'archetype'; };?>.</p>
                        <p>Now, I'd like to show you how you can turn any dilemma, misfortune, or situation into a favourable outcome by converting this newfound wisdom into correct responses.</p>
                        <p class="sp-title">Gain Guidance, Insights, Direction - All Personalized To Your <?php if (empty($_GET['archetype'])) { echo 'archetype'; } else { echo $_GET['archetype'] . ' ' . 'archetype'; };?>.</p>
                        <p>By gaining exclusive access to your Premium Daily Archetypes in your private Member's Area, you can receive daily guidance telling you the best course of action to take and the important signs you need to look out for, all personalized to your archetype.</p>
                        ...
                        <p>Your Premium Daily Archetypes will give you direct answers, guiding you to the correct response you need to make a massive comeback in every aspect of your life!</p>
                        <p>That's not all...</p>
                        <p class="sp-title">Reinforce Your Future With Premium Daily Archetype Readings</p>
                        <p>Your Premium Daily Archetypes provides you with <strong>action steps, exercises, and specific direction, every single day.</strong></p>
                        <p>By having exclusive access to your Premium Daily Archetypes in our private Member's Area, you can receive daily guidance telling you the best course of action to take and the important signs you need to look out for.</p>
                        ...
                        <img class="pda-access" src="https://individualogist.com/offer/assets/img/pda-access.png">
                        <p class="sp-title">Gain Instant Access To Your Premium Daily Archetypes For FREE</p>
                        ...
                        <p>From this day forth, you can start making changes in your life that align with your authentic self and true purpose...</p>
                        <p>...And finally be able to overcome any challenge, obstacle, or opportunity that might come your way.</p>
                        
                        <div class="testimonial">
                            <span class="archetype-xs creator"></span>
                            <h2 class="testimonial-header"></h2>
                            <p class="testimonial-text">Before Individualogist, my live was full of ignorance and negatieve energies. Now, I know that everything that I had learned had one single purpose. I am thankful to God and Individualogist for guiding me through my life path, and the lessons that life has given me.</p>
                            <p class="testimonial-author">Sebastian Tabor, 26, Design & Manufacturing Engineer - Creator</p>
                        </div>
                        
                        <div class="testimonial">
                            <span class="archetype-xs magician"></span>
                            <h2 class="testimonial-header"></h2>
                            <p class="testimonial-text">I love your products. They are very accurate and have helped me to understand myself so much better. I have purchased many of your products over the past year. I have been very pleased with each and every purchase. I feel more comfortable and confident in my own skin now. I have found the love of my life and have been helping my children with finding their paths in this life with your products. You really have a wonderful way of getting my full attention, which is not an easy task. I really enjoy your products and your emails. Thank you for all you support.</p>
                            <p class="testimonial-author">Peggy Sue Conner, 40, Stay At Home Mom - Magician</p>
                        </div>
                        
                        <div class="testimonial">
                            <span class="archetype-xs member"></span>
                            <h2 class="testimonial-header"></h2>
                            <p class="testimonial-text">Wow it was very accurate and very reassuring some things mentioned in it! I have been doing on my own and knowing I'm on the right path in some areas is reassuring to me. And also gives me confidence that other journeys I to want take, like pursuing another career in a particular field, is something I should do.</p>
                            <p class="testimonial-author">Danielle Jones, 32, Education - Member</p>
                        </div>
                        
                        <div class="testimonial">
                            <span class="archetype-xs outlaw"></span>
                            <h2 class="testimonial-header"></h2>
                            <p class="testimonial-text">I have learned to appreciate qualities that I have suppressed for years. I am a lot more outspoken, brave enough to share my truth with others, and I feel a lot more comfortable in my own skin.</p>
                            <p class="testimonial-author">Sheena Staton, 37, Freelance Writer - Outlaw</p>
                        </div>
                        
                        <div class="testimonial">
                            <span class="archetype-xs hero"></span>
                            <h2 class="testimonial-header"></h2>
                            <p class="testimonial-text">This was amazing for me, I had never seem anything like this in anywhere else. The content is full of who we really are, it's a good investment!</p>
                            <p class="testimonial-author">Caique de Farias, 24, Student - Hero</p>
                        </div>
                        ...
                        <div class="order-form">
                            <h2 class="order-title">Yes! Claim My Premium Daily Archetypes (7-Day Free Trial - Cancel Anytime)</h2>
                             
                            <?php
                             if (empty($name)) {
                                echo "<a class='btn buy-button' href='http://pda-ft.individua1.pay.clickbank.net/?cbskin=25048&cbtimer=68&vtid=$vtid'>Yes! Add To My Order!</a>";
                             } else {
                                echo "<a class='btn buy-button' href='http://pda-ft.individua1.pay.clickbank.net/?cbskin=25048&cbtimer=68&name=$name&email=$email&vtid=$vtid'>Yes! Add To My Order!</a>";
                             }
                            ?>
                            
                            <?php
                             if (empty($name)) {
                                echo "<a class='buy-link' href='http://pda-ft.individua1.pay.clickbank.net/?cbskin=25048&cbtimer=68&vtid=$vtid'>Click Here To Claim Your Premium Daily Archetypes!</a>";
                             } else {
                                echo "<a class='buy-link' href='http://pda-ft.individua1.pay.clickbank.net/?cbskin=25048&cbtimer=68&name=$name&email=$email&vtid=$vtid'>Click Here To Claim Your Premium Daily Archetypes!</a>";
                             }
                            ?>
                            ...
                            <div class="order-footer">
                                This is a subscription-based service with a 7-day trial. You will be billed nothing today, and then $17.00 every month after your trial expires. You are free to cancel at any time.
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container-fluid bg-white text-dark">
                <div class="row">
                    <div class="faq-wrapper col-sm-8 mx-auto">
                        ...
                        <p>Each daily reading ranges between 300 to 500 words, giving you a sufficient amount of details to get a sense of what aspects you should focus on each day, helping you make better decisions that are aligned to your archetype.</p>
