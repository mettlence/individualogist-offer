...
<style>
  ...
  .squaresphere{background-image:url('/offer/assets/img/bg-squaresphere.jpg');border-radius:0 0 20% 20%;box-shadow:0 5px 15px rgba(0,0,0,.3);}
  .meditateneon{position:relative;background-image:url('/offer/assets/img/bg-meditateneon.jpg');padding-top:2em;padding-bottom:2em;color:#fff;text-shadow:1px 1px 1px #000}
  ...
  .magicspark {font-size:1.2em;background-position:center;background-size:cover;width:100%;background-image:url('/offer/assets/img/bg-magicspark.jpg');position:relative;padding:2em}
  ...
  .ul-crystal > li:before {position: absolute;left: -40px;display: inline-block;width: 22px;height: 20px;margin-right: 1em;background: url(/offer/assets/img/crystal-icon.png) no-repeat;background-size: cover;background-position: 100% 100%;border-radius: 50%;content: "";top: 5px;}
  ...
  .stars{width:100px;height:30px;background:url('/offer/assets/img/5stars.png');background-size:contain;background-repeat:no-repeat;display:block;position:relative;margin: 0 auto}
  ...
  .indi-logo{position:relative;height:100px;width:200px;background:url('/offer/assets/img/individualogist-logo2.png');margin: 0 auto;display:block;background-size:contain;background-repeat:no-repeat}
  .multistep{position:relative;height:86.5px;width:100%;max-width:1024px;background:url('/offer/assets/img/multistep.png');margin: 0 auto;display:block;background-size:contain;background-repeat:no-repeat}
  ...
  .alert-icon{background:url('/offer/assets/img/alert-icon.png');width:100px;height:100px;margin:0 auto;display:block;background-size:contain;background-repeat:no-repeat;}
  ...
  .headline-bg{max-width:1024px;margin: 0 auto;position:relative;background:url('/offer/assets/img/bg-cosmospink.png');background-repeat:no-repeat;background-attachment:fixed;background-size:cover;background-position:center center;padding: 1em;color:#fff;text-shadow:1px 1px 1px #000;width:100%}
  ...
  <div class="container">
      <div class="row">
          <div class="col-sm-8 mx-auto mt-3 mb-3 bg-white p-1">
              ...
              <img src="/offer/assets/img/sphere-2s.png" class="ets">
...
<script type="text/javascript" src="/offer/paa/js/custom.js"></script>
<script>
