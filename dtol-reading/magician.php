        <h2 class="sub-header"><span class="cap"><?php echo $name;?></span>, You Are The Magician - And This Is What It Means...</h2>

        <p><span class="cap"><?php echo $name;?></span>, the Magician archetype is one that has forged deep connections with the universe... Amongst all the archetypes, the Magician is perhaps the most difficult to comprehend, and you're well aware of that. You have a strong, unbreakable belief in your dreams, abilities, and yourself.</p>
        ...
        <p>That, however, also means that you have tendency to be rather distant, even though you're able to recognize the most intricate details about people. You instinctively know who to trust, and who to look out for. Others might label you as judgmental or perhaps a little too critical, but your deductions are often, or almost alawys right.</p>
        ...
        <img class="img-intext" src="../assets/img/icons/magician.png">

        <p><span class="cap"><?php echo $name;?></span>, there is a strong sense of discipline within you. Unlike other archetypes, you're not afraid of hardwork, and you're not afraid of suffering. Rather, you thrive on it.</p>
        ...
        <p>The Magician archetype is one that also has the tendency to become manipulative and scheming. For the most part, you do exercise compassion and your heart's often in the right place. But it's also important to learn to be forgiving and patience, <span class="cap"><?php echo $name;?></span>...</p>
        ...
        <p>There's something else about your archetype, <span class="cap"><?php echo $name;?></span>... You're also incredibly versatile. You're able to assume different roles according to different situations - very much like an actual magician, who has numerous tricks hidden in his sleeves.</p>
        ...
        <p>Based on the strengths of your archetype, you're an individual who's highly observant, and incredibly resourceful.</p>

        <!--Insert Strength Image-->
        <img class="img-intext" src="../assets/img/strength.png">

        <p><span class="cap"><?php echo $name;?></span>, as a Magician, you're actually a lot more nurturing than you think. You might appear to be a little bit emotionally detached on the outside, but when you're alone, you're actually someone who's warm, caring, and tender.</p>
        ...
        <h2 class="sub-header">Unfortunately, Not All Is Smooth-Sailing For The Magnificent Magician, <span class="cap"><?php echo $name;?></span>... These Are The Shortcomings You Must Look Out For.</h2>
        ...
        <p>But that's also indicative of a deeper fear that resides within you, <span class="cap"><?php echo $name;?></span>... The fear of failing others... And failing yourself</p>
        ...
        <p>You must understand that life has so much more to offer, and people are not determined by their ability to meet your expectations - much less yourself. It will be impossible to avoid such setbacks entirely, but how you handle these upsets will determine the <span ckass="purple">destination of your journey.</span></p>
        ...
        <h2 class="sub-header"><span class="cap"><?php echo $name;?></span>, As A Magician, This Is Your Calling... And It's Beyond Your Wildest Imaginations</h2>

        <p>While others seem to find it difficult to even understand the fundamentals of a new skill, you’re able to attain mastery over anything you set your mind to. In a way, your greatest strength is your ability to learn.</p>
        ...
        <p><span class="cap"><?php echo $name;?></span>, you have the capacity to perform great feats in your lifetime. But you must remember that you cannot do everything on your own - and that's where forging valuable connections with others will come into play.</p>

        <h2 class="sub-header">Here's A Glimpse Into Your Love Compatibility With Other Archetypes...</h2>

        <img class="love-img" src="../assets/img/love/magician-love-compatibility.png">
        ...
        <p>The Magician archetype is known to be faithful, tender, and devoted in a relationship... You're giving and understanding - attributes than any lover would cherish.</p>

        <p><span class="cap"><?php echo $name;?></span>, as much as you dislike to admit it, there is a strong yearning for romance that resides within you. And that's supported by your faithfulness and committment in a relationship.</p>
