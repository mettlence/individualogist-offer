        <h2 class="sub-header"><span class="cap"><?php echo $name;?></span>, You Are The Caregiver - And This Is What It Means...</h2>

        <p><span class="cap"><?php echo $name;?></span>, you are an individual who posseses great capacities of love... An individual whose sole purpose is to give large chunks of yourself to others.</p>
        ...
        <p>You'd very much rather be underestimated than overestimated, isn't that right, <span class="cap"><?php echo $name;?></span>?</p>
        ...
        <p>You might not be aware of this, <span class="cap"><?php echo $name;?></span>... But your generosity does not go unnoticed. In fact, it inspires and encourages literally every one around you.</p>
        ...
        <h2 class="sub-header">Unfortunately, Not All Is Smooth-Sailing For The Magnanimous Caregiver, <span class="cap"><?php echo $_GET['name']; ?>... These Are The Shortcomings You Must Look Out For.</span></h2>
        ...
        <p>Bullies have their eye on you, <span class="cap"><?php echo $name;?></span> - cowards who have to rely on throwing their weight around to make themselves feel strong.</p>
        ...
        <h2 class="sub-header"><span class="cap"><?php echo $name;?></span>, As A Caregiver, This Is Your Calling And Direction In Life... And It's Beyond Your Wildest Imaginations.</h2>
        ...
        <img class="love-img" src="../assets/img/love/caregiver-love-compatibility.png">

        <p><span class="cap"><?php echo $name;?></span>, do you see that chart on top? That little chart over there represents the archetypes that you’re most likely to end up with. Or if you’re already in a committed relationship, there’s a really good chance that your spouse is one of those archetypes.</p>
