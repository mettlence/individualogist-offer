        <h2 class="sub-header"><span class="cap"><?php echo $name;?></span>, You Are The Lover - And This Is What It Means...</h2>
        ...
        <p><span class="cap"><?php echo $name;?></span>, The Lover archetype is one of profound sensitivity, and deep emotional connection. That means that you are an individual who experiences the extremities of all emotions. Your happiness is often an elation beyond description, while your pain feels like it can be excruciating and crippling...</p>
        ...
        <p>Your archetype also suggests that you're soft-hearted, gentle, and mellow. You're the type of person who  reaches out to the quitest person in the room, trying your best to make everyone feel comfortable.</p>

        <p>Amongst all the archetypes, yours has the greatest tendency to romanticizie things... Whether it's your relationships, Not that it's a bad thing, of course. It's just a part of who you are. You're expressive as a person, and you're undivded with your attention.</p>
        ...
        <p>And as you might have already guessed by now, even though you draw energy from being by yourself, you're a lot more people-oriented that you think, <span class="cap"><?php echo $name;?></span>
        ...
        <p>There's something else about your archetype, <span class="cap"><?php echo $name;?></span>... Nothing pleases you more than expressing love, and receiving love. Although, the type of love in question does not necessarily solely refer to romance or courtship. It also includes love between friends, family, and even strangers.</p>
        ...
        <p>As a Lover, you center your life around one thing - love. Your archetype's greatest obsession involves a combination of  intimacy, and experience...  An outlook on life that motivates you to develop yourself in terms of emotional maturity.</p>

        <p>Apart from that, you seem have a discnering understanding of what it means to love - one that adopts a more philosophical point of view, and also, one that grants you special talents when it comes to empathy and affinity.</p>
        ...
        <h2 class="sub-header">Unfortunately, Not All Is Smooth-Sailing For The Romantic Lover, <span class="cap"><?php echo $name;?></span>... These Are The Shortcomings You Must Look Out For.</h2>
        ...
        <p>Do not be alarmed - this is all part and parcel of what it means to be a Lover. And with your Archetypal Introduction, all of that will soon change.</p>
        ...
        <h2 class="sub-header"><span class="cap"><?php echo $name;?></span>, As A Lover, This Is Your Calling... And It's Beyond Your Wildest Imaginations</h2>
