        <h2 class="sub-header"><span class="cap"><?php echo $name;?></span>, You Are The Hero - And This Is What It Means...</h2>
        ...
        <p>The Hero archetype is best represented through the essence of sacrifice. Whether it's putting the needs of others in front of your own, or simply taking the initiative to serve the greater good, you're always in the front of the line.</p>
        ...
        <img class="img-intext" src="../assets/img/icons/hero.png">

        <p>Fellow Hero, your archetype also suggests that there is a side of you that's relentless... Relentless in the sense of striving to improve yourself - whether it's your physical abilities, your mental fortitude, or your emotional resilience.</p> 
        ...
        <p>You seem to exercise selflessness in everything that you do, <span class="cap"><?php echo $name;?></span>... No matter how small or miniscule your actions appear to be, every decision that you make, no matter how small, is always for a purpose that serves others. And when it comes to making important and difficult decisions, you're assertive, firm, and steadfast.</p>

        <p>The Hero archetype also suggests that you're an individual of great empathy, and a strong sense of justice. You're intolerant when you encounter unfairness or corruption of any sort, and there's burning desire that drives you to want to do all forms of prejudice.
        ...
        <p>The Hero archetype is one that strives for greatness. You have a strong vision of what you want to achieve in your lifetime - a vision that few will comprehend, but many will appreciate... Your compassion for your fellow man is what ultimately gives you the desire to change the world.</p>
        ...
        <p>You might not be aware of this, <span class="cap"><?php echo $name;?></span>... But your willingness to step up to the plate is inspiring and encouraging to the people around you - strangers, friends, and loved ones. And because of this, your archetype truly has the capacity to achieve greatness.</p>
        ...
        <p>Within your archetype lies a number of leadership qualities... Especially since you're someone who's self-aware, decisive, and somewhat stern. People find themselves calmed by your presence, knowing that they have someone reliable and dependable by their side.</p>
        ...
        <p><span class="cap"><?php echo $name;?></span>, it's become abundantly clear that you'll experience the greatest amount of fulfillment and joy from pursuing a career that will allow you to make difficult decisions, and give you a strong sense of duty...</p>
        ...
        <p>You see, <span class="cap"><?php echo $name;?></span> - you have a rather intense aura. That does not mean to say that it's a bad thing - after all, when it comes to getting things done, you'll always be on the top of everyone's lists.</p>
        ...
        <h2 class="sub-header">Unfortunately, Not All Is Smooth-Sailing For The Courageous Hero, <span class="cap"><?php echo $name;?></span>... These Are The Shortcomings You Must Look Out For.</h2>
        ...
        <p>You see, <span class="cap"><?php echo $name;?></span>, despite your brave frontier, there are fears that reside within your archetype... Deep-seated fears that appear miniscule to others, but appear menacing to you.</p>
        ...
        <p>Perhaps that might be why you concern yourself so much with appearances... Because without appearances, you're afraid that you'll lose your self-construed identity. That is perhaps, the greatest challenge that you must overcome, <span class="cap"><?php echo $name;?></span></p>
        ...
        <p><span class="cap"><?php echo $name;?></span>, advancement and growth are products of both time and effort, and when you implement that to become a part of your life, your passage to fulfillment will be revealed to you... All in due time.</p>
        ...
        <p>After all, this is the Hero's motto... When there's a will, there's a way. And that saying really shines through your actions and behaviour, <span class="cap"><?php echo $name;?></span>.</p>

        <h2 class="sub-header">As A Hero, This Is Your Calling... And It's Beyond Your Wildest Imaginations</h2>

        <p><span class="cap"><?php echo $name;?></span>, ultimately, you are a realist – someone who sets and achieves realistic goals. You're not comfortable with being wishy-washy or fickle-minded. When you've set your mind to something, you'll do everything it takes to make it happen.</p>
        ...
        <h2 class="sub-header"><span class="cap"><?php echo $name;?></span>, Here's A Glimpse Into Your Love Compatibility With Other Archetypes...</h2>

        <img class="love-img" src="../assets/img/love/hero-love-compatibility.png">
        ...
        <p>Yourhe Hero archetype is a giving, faithful, and dependable lover. The ideal, dream-like partner who appears to be textbook-perfect.</p>
