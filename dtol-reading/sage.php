        <h2 class="sub-header"><span class="cap"><?php echo $name;?></span>, You Are The Sage - And This Is What It Means...</h2>

        <p><span class="cap"><?php echo $name;?></span>, the Sage is highly dedicated when it comes to seeking two things: knowledge and wisdom. That's what forms the foundation of the Sage archetype - it's what it lives for, and what it thrives on.</p>
        ...
        <img class="img-intext" src="../assets/img/icons/sage.png">

        <p><span class="cap"><?php echo $name;?></span>, although you have the desire to attain knowledge, there are instances where you prefer to listen to your own intuition.</p>
        ...
        <p>You are certainly not one to be motivated by material possessions. You're far more interested in discovering the way to attaining inner peace.</p>
        ...
        <p><span class="cap"><?php echo $name;?></span>, your curiosity is what contributes to your vast pool of knowledge, but that is not what ultimately defines you as a Sage.</p>
        ...
        <p>But we'll discuss that in greater detail as we progress through this Archetypal Introduction, <span class="cap"><?php echo $name;?></span>.</p>
        ...
        <p><span class="cap"><?php echo $name;?></span>, as a Sage, you're supportive and accepting of people of different backgrounds and beliefs - that trait of yours is resemblant of your people-oriented nature.</p>
        ...
        <h2 class="sub-header">Unfortunately, Not All Is Smooth-Sailing For The Wise Sage... These Are The Shortcomings You Must Look Out For.</h2>

        <p>This portion of your Archetypal Introduction does not seek to scare you, <span class="cap"><?php echo $name;?></span>... But it's best that you be made aware of the potential challenges that lie ahead of you - or perhaps you've encountered some of these challenges already.</p>
        ...
        <p><span class="cap"><?php echo $name;?></span>, that challenge originates from a deeper fear that resides within you... and that is your fear of being wrong.</p>
        ...
        <h2 class="sub-header"><span class="cap"><?php echo $name;?></span>, As A Sage, This Is Your Calling... And It's Beyond Your Wildest Imaginations</h2>

        <p><span class="cap"><?php echo $name;?></span>, you take an interest in a broad number of subjects, and your fulfilment is derived from learning. This means that you're greatest path to fulfilment can be found through a combination of engaging your mind, and translating that into motion.</p>
        ...
        <p>Your calling in life will revolve primarily around those traits. As long as you're able to be in a position where you're able to keep your mind active and be given opportunities to execute your ideas, you will experience the rewarding sense of accomplishment.</p>
        ...
        <img class="love-img" src="../assets/img/love/sage-love-compatibility.png">

        <p>The chart that you see above represents the archetypes that you’re most likely to end up with. Or if you’re already in a committed relationship, there’s a really good chance that your spouse is one of those archetypes.</p>
