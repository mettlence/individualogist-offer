        <h2 class="sub-header"><span class="cap"><?php echo $name;?></span>, You Are The Innocent - And This Is What It Means...</h2>

        <p><span class="cap"><?php echo $name;?></span>, before you dismiss this Archetypal Introduction as nothing but hogwash, you must know that the Innocent archetype is NOT one that's typically associated with naivety. Truth be told, it is anything but. If you'd like to find out the truth about what the Innocent really resembles, then please proceed with the rest of this Archetypal Introduction with an open mind, and a willing heart.</p>

        <p>The Innocent archetype is best defined by its sheer positivity, enthusiasim, and optimism. They're able to interpret any situation in a perspective that's hopeful, encouraging, and infectious. If you're thinking that there's a lot more to the Innocent archetype than just that, you're exactly right!</p>
        ...
        <p>To you, everyone has a story worth listening to, every circumstance holds something worth experiencing, and everything that happens in life,  happens for a reason. That is a belief; a deep-rooted outlook that makes the Innocent archetype so remarkable.</p>

        <!--Insert Archetype Icon-->
        <img class="img-intext" src="../assets/img/icons/innocent.png">

        <p><span class="cap"><?php echo $name;?></span>, your archetype also suggests that there is a side of you that's relentless... Relentless in the sense of striving to improve yourself - whether it's your physical abilities, your mental fortitude, or your emotional resilience. That being said, you're certainly an individual of impressive characteristics - characteristics that are unique to your archetype.</p>
        ...
        <p>The Innocent archetype also suggests that you're simple, easy-going, and transparent. You're the type of person who's willing to wear your heart on your sleeve, stand up for your beliefs, and face the consequences of mistakes... An upstanding individual who's fearless in profound ways.
        ...
        <p>You try not to be serious most of the time, and you enjoy engaging in little things that will make someone else's day brighter. Whether it's pretending to laugh at a corny joke, applauding a predictable magic trick, you'd very much rather bless that person with positivty than put them down.</p>

        <p>And that's just a small piece of the puzzle that forms the entirety of the wonderful, angelic individual that you are. Unlike the archetypes who tend to struggle with hatred and anomisoty, you'd very much rather make friends than enemies. You're accepting, kind, and incredibly thoughtful.</p>
        ...
        <p>That's why the world needs more people like you, <span class="cap"><?php echo $name;?></span>... I have no doubt that you will one day infect others with your positivity, and influence them to have the same tenacity as you.</p>
        ...
        <p>But that's not all there is to the Innocent archetype, <span class="cap"><?php echo $name;?></span>... This is merely the beginning. As an Innocent, you are selfless - often putting your needs behind the needs of others.</p>

        <p>You put your best in everything that you do, and you always make sure that your heart's in the right place.</p>

        <p>There's something else about your archetype... You're far more magnanimous than others - always ready to  give more than you're willing to receive. And that stems from your willingness to see the goodness in people.</p> 

        <p>In your eyes, all man is deserving of kindness - and that really translates through your actions.</p>

        <p><span class="cap"><?php echo $name;?></span>, based on the strengths of your archetype, there is no doubt that you're an individual who makes a forgiving partner, a nurturing parent, and a dependable friend.</p>

        <!--Insert Strength Image-->
        <img class="img-intext" src="../assets/img/strength.png">

        <p>It's become abundantly clear that you'll experience the greatest amount of fulfillment and joy from pursuing a career that will allow you to motivate and bring out the best in others... A noble duty that grows in greater demand as society becomes more detached and emotionally disconnectd.</p>

        <p>Beyond that, you have a profound understanding of the innerworkings of the human soul. Your empathtic nature allows you to comprehend what someone else is going through, and you always seem to know how to lead them out of darkness.</p> 

        <p>In many ways, you're the beacon of hope that has and will touch the lives of many.</p>

        <p>In terms of your behaviour around others, you're always ready to offer a listening ear. You're always swift to listen, but slow to speak. If you've ever wondered why people are always sharing their deepest troubles with you, that is the exact reason why, <span class="cap"><?php echo $name;?></span>

        <p>You see, your archetype exudes an aura of purity. You trust others just as easily as others are able to place their trust in you. That's because your earnestness really shows through your personality.</p>
            
        <p>But there are obstacles that stand before you... Obstacles that you must be made aware of...</p>

        <h2 class="sub-header">Unfortunately, Not All Is Smooth-Sailing For The Virtuous Innocent, <span class="cap"><?php echo $name;?></span>... These Are The Shortcomings You Must Look Out For.</h2>
        ...
        <img class="img-intext" src="../assets/img/sailing.png">

        <p>However, I have no doubt that with your strengths, resilience, and fortitude, you will overcome all that stands in your way, <span class="cap"><?php echo $name;?></span>.</p>
        ...
        <p>As an Innocent, it is vital for you to take up the challenge of stepping out of your comfort zone. Being surrounded with unfamiliarity will allow room for you, as an Innocent, to develop and improve yourself. It does not have to toe the lines of extremeities - just small, little, progressive steps.</p>
        ...
        <p>Perhaps that might be why you concern yourself so much with the familiar, <span class="cap"><?php echo $name;?></span>... Because beyond the familiar, you're afraid that you'll lose your self-construed identity. That is perhaps, the greatest challenge that you must overcome.</p>
        ...
        <h2 class="sub-header"><span class="cap"><?php echo $name;?></span>, As An Innocent, This Is Your Calling... And It's Beyond Your Wildest Imaginations</h2>

        <p>You are on a quest – a quest for happiness; for joy. And as forementioned, your archetype tends to struggle with finding fulfilment...</p> 
        ...
        <p>And that's where your calling resides, <span class="cap"><?php echo $name;?></span>. You want to live life for yourself, a life of abundance and joy.</p>

        <h2 class="sub-header">Here's A Glimpse Into Your Love Compatibility With Other Archetypes...</h2>

        <img class="love-img" src="../assets/img/love/innocent-love-compatibility.png">
        ...
        <p>It might take a while before you find the right one, <span class="cap"><?php echo $name;?></span> - but as the saying goes, good things come to those who wait. If you're not in a committed relationship, your best bet will be to exercise patience and caution during your search for a romantic partner.</p>
