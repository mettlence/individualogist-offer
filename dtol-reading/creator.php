        <h2 class="sub-header"><span class="cap"><?php echo $name;?></span>, You Are The Creator - And This Is What It Means...</h2>

        <p><span class="cap"><?php echo $name;?></span>, you are an individual who posseses a stupendous amount of creativity... An individual whose sole purpose is to express yourself through your idealistic and innovative mind.</p>

        <p>That being said, you truly are a unique individual... And needless to say, the world certainly needs more people like you.</p>

        <p>You're someone who's also incredibly resourceful, scrappy, and imaginative... Finding all sorts of ways to express your ideas and feelings. Because of this, you're also somoene who's well-respected by the others around you - for your talents and abilities in the things, hobbies, and skills that you're passionate about.</p>

        <!--Insert Archetype Icon-->
        <img class="img-intext" src="../assets/img/icons/creator.png">
        ...
        <p><span class="cap"><?php echo $name;?></span>, your archetype also suggests that you're often on the lookout for opportunities to showcase your talents. After all, the admiration and respect that you receive can feel rather rewarding, doesn't it?</p>
        ...
        <p>And unlike others, you're not exactly the mostsociable person on the planet... On a bright Sunday afternoon, you'd very much prefer to remain in the comfort of your own home - honing your talents and improving yourself instead of being out shopping or spending time with your friends.</p>

        <p>You might not be aware of this, <span class="cap"><?php echo $name;?></span>... But your creativity is inspiring and encouraging to the people around you - mostly your peers. And because of this, your archetype truly has the capacity to achieve greatness.</p>
        ...
        <p><span class="cap"><?php echo $name;?></span>, although you tend to be rather aloof in the conversations that you share with others, you do also seem to enjoy the occasional chit-chat. That's because you've constructed thick barriers between you and the rest of the world - but unfortunately, it can get a little at times...</p>

        <p>That's why you're more than elated whenever someone comes to you for a listening ear.</p>

        <p>That's also explains your introspective tendencies - especially when you're on your own. It's not unusual for philosphical thoughts to cross your mind ever so often. You seem to draw energy from being by yourself, and expending energy when you're surrounded by others.</p>
        ...
        <p>Beyond that, <span class="cap"><?php echo $name;?></span>, you're also someone who's open-minded. You're very accepting of people who come from different backgrounds. You have the sense to realize that different perspectives exist, and you're always reminding yourself to be respectful of that.</p>
        ...
        <h2 class="sub-header">Unfortunately, Not All Is Smooth-Sailing For The Inventive Creator, <span class="cap"><?php echo $name;?></span>... These Are The Shortcomings You Must Look Out For.</h2>
        ...
        <p>You see, there are fears that reside within your archetype... Deep-seated fears that appear miniscule to others, but appear menacing to you.</p>

        <p>Your archetype tends to be fearful of appearing unoriginal, or even mediocre. And this stems from one thing, <span class="cap"><?php echo $name;?></span>... It stems from the concern that you have of how others perceive you.</p>

        <p>Although you're always telling yourself not to care, there's a part of you that struggles to let go. And even though you manage to successfuly convince yourself some times, you eventually fall back into the same patterns and same routines.</p>

        <p>Don't let that discourage you, <span class="cap"><?php echo $name;?></span>. You possess a strong source of inner strength...  And your fears are certainly far more profound than the fears of others. Society has evolved into a platform of judgments - people judge, and are therefore afraid of being judged. And the sooner you recognize that, the sooner you'll be able to step out of that domain.</p>
        ...
        <p>To maximize the abilities of your archetype, <span class="cap"><?php echo $name;?></span>, you must always be trying, always be experimenting, and always be failing. As ironic as it sounds, that is the journey that will lead you to your eventual success.</p>

        <h2 class="sub-header">As A Creator, This Is Your Calling... And It's Beyond Your Wildest Imaginations</h2>

        <p><span class="cap"><?php echo $name;?></span>, you are the epitome of expression – possessing the uncanny ability to communicate your emotions in the most creative, yet accurate ways. You excel at one-on-one interactions, and never fail to make an excellent impression on others. Your unique thinking and intelligence intrigues people.</p>
        ...
        <img class="love-img" src="../assets/img/love/creator-love-compatibility.png">
        ...
        <p><span class="cap"><?php echo $name;?></span>, you tend to be slightly neglectful as a lover - and I'm sure some of your exes or current partner will agree with me on this.</p>
        ...
        <p>Despite all of that, you're intensely committed to your partner - it's unlike you to have your heart stray, unless the circumstances of your relationship toe the lines of extemities.</p>
