        <h2 class="sub-header"><span class="cap"><?php echo $name;?></span>, You Are The Outlaw - And This Is What It Means...</h2>
        ...
        <p>As an Outlaw, <span class="cap"><?php echo $name;?></span>, accountability to others makes you feel trapped, and that's why you prefer to answer to no one. </p>
        ...
        <img class="img-intext" src="../assets/img/icons/outlaw.png">
        ...
        <p>You do have vigilante tendencies, <span class="cap"><?php echo $name;?></span>... If given the chance to take matters into your own hands, you would not blink twice. That, however, sometimes lands you into trouble.</p>
        ...
        <p><span class="cap"><?php echo $name;?></span>, in more ways than one, you have a strong sense of mission - an agent of change, if you will. That stems from your firm belief in the fact that everyone is born equal. And you will do whatever it takes to make it so.</p>
        ...
        <p>You are passionate, extreme, and authentic.</p>
        ...
        <p><span class="cap"><?php echo $name;?></span>, as an Outlaw, you're brave and fearless when it comes to standing up for your beliefs and principles. You could not care less about being judged by others, as long as you stay true to yourself.</p>
        ...
        <p>There are traits of profound leadership that are hidden within you - hidden because they have yet to be fully explored and cultivated. You're able to rally support, and compel people to believe in your cause.</p>
        
        <p>But there are obstacles that stand before you... Obstacles that you must be made aware of...</p>
        
        <h2 class="sub-header">Unfortunately, Not All Is Smooth-Sailing For The Notorious Outlaw, <span class="cap"><?php echo $name;?></span>... These Are The Shortcomings You Must Look Out For.</h2>
        ...
        <p>It's likely that you find the same questions repeating in your head, <span class="cap"><?php echo $name;?></span>... About someone else's ulterior motives, about someone else's phony and artificial beliefs, about someone else's trustworthiness as a whole.</p>
        ...
        <p><span class="cap"><?php echo $name;?></span>, do not be alarmed - this is all part and parcel of what it means to be a Member. And with your Archetypal Introduction, all of that will soon change.</p>
        ...
        <h2 class="sub-header"><span class="cap"><?php echo $name;?></span>, As An Outlaw, This Is Your Calling... And It's Beyond Your Wildest Imaginations</h2>
        ...
        <img class="love-img" src="../assets/img/love/outlaw-love-compatibility.png">
        ...
        <p>The Outlaw archetype is known to be mysterious, passionate, and intruiging in a relationship... You're enigmatic and obscure, and potential romantic partners find that attractive about you.</p>

        <p>You tend to gravitate towards relationships that are temporary and short-lived. You're fully committed during the duration that it lasts, but when the flame goes out, you're ready to move on.</p>
        ...
        <p>However, that might all change if you were to find the perfect partner for you, <span class="cap"><?php echo $name;?></span>.</p>
