        <h2 class="sub-header"><span class="cap"><?php echo $name;?></span>, You Are The Ruler - And This Is What It Means...</h2>
        ...
        <p><span class="cap"><?php echo $name;?></span>, the Ruler archetype is best illustrated through the decisions that you make. You are often fair, just, and honourable.</p>
        ...
        <img class="img-intext" src="../assets/img/icons/ruler.png">
        ...
        <p><span class="cap"><?php echo $name;?></span>, you are also idealistic when it comes to your goals - a strong sign of a visionary. You refuse to fall short of your objectives, and you consider consolation as an indicator of failure.</p>
        ...
        <p>You are inspiring, confident, and determined.</p>
        ...
        <p><span class="cap"><?php echo $name;?></span>, as a Ruler, you're gallant and audacious when it comes to taking massive action. Whether it's embarking on an unfamiliar personal journey, or putting a new idea to the test, you're swift to move.</p>
        ...
        <h2 class="sub-header">Unfortunately, Not All Is Smooth-Sailing For The Decisive Ruler, <span class="cap"><?php echo $name;?></span>... These Are The Shortcomings You Must Look Out For.</h2>
        ...
        <p>However, I have no doubt that with your Archetypal strengths and personality traits, , you will overcome all that stands in your way, <span class="cap"><?php echo $name;?></span>.</p>
        ...
        <p>That challenge often stems from your refusal to seek help from others, perhaps from a lack of trust in the people around you. It also originates from a deeper fear that resides within you... and that is your fear of losing control.</p>
        ...
        <p>And that leads us to your greatest challenge of all, <span class="cap"><?php echo $name;?></span> - and that is overcoming yourself.</p>
        ...
        <h2 class="sub-header"><span class="cap"><?php echo $name;?></span>, As A Ruler, This Is Your Calling... And It's Beyond Your Wildest Imaginations</h2>
        ...
        <img class="love-img" src="../assets/img/love/ruler-love-compatibility.png">
