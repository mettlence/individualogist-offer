        <h2 class="sub-header"><span class="cap"><?php echo $name;?></span>, You Are The Jester - And This Is What It Means...</h2>

        <p><span class="cap"><?php echo $name;?></span>, before you dismiss this Archetypal Introduction as nothing but hogwash, you must know that the Jester archetype is NOT one that's solely represented as a mere joker.</p> 
        ...
        <p>The Jester archetype is blessed with astute, sharp, and quick-witted. That means that you are an individual who is able to approach a varierty of topics from a myriad of perspectives. Despite your playful appearance and mischievious behaviour, you are nimble and brilliant in your own unique way.
        ...
        <p>Others might perceive you to be an individual who's more emotional because of your spontaneity... But, you are in fact, more intuitive and perceptive than you make yourself out to be. After all, your excellent sense of humour is constructed with creativity, and seasoned with your charisma. And that requires a certain calibre of incisiveness.</p>

        <!--Insert Archetype Icon-->
        <img class="img-intext" src="../assets/img/icons/jester.png">
        ...
        <p>People find themselves drawn to you because of your ability to spice up your conversations. And all of that just seems to come naturally to you, doesn't it, <span class="cap"><?php echo $name;?></span>? Your personable body language and outgoing attitude towards in life makes you a sheer joy to be around.</p>

        <p>The Jester archetype also suggests that you're casual, easy-going, and free-spirited. You're the type of person who allows your imagination to run wild, conjuring the most ridiculous ideas and painting the silliest images in your head... An individual who simply doesn't take life too seriously.
        ...
        <p>You might not like to admit it... But you tend to waiver a bit when it comes to serious situations or harsh conversations. You'd very much rather avoid such instances entirely, instead of having to actually deal with them. That is a struggle that you must be careful of. But we'll speak more to that later.</p>
        ...
        <p><span class="cap"><?php echo $name;?></span>, you are an individual who's impressionable, cheerful, and intriguing. You seem to be able to blend into any social group, and you have a wide circle of friends.</p> 
        ...
        <p>There's something else about your archetype... Nothing pleases you more than experiencing the joys and emotions of life at its maximum. In tha face of adversity, you're somehow able to move past setbacks quickly, and effortlessly.</p>

        <p>Based on the strengths of your archetype, nothing seems to be able to put you down - or not for long, to say the least.</p>

        <!--Insert Strength Image-->
        <img class="img-intext" src="../assets/img/strength.png">

        <p><span class="cap"><?php echo $name;?></span>, as a Jester, you center your life around one thing - living in the present. You live life according to your own rules, and that states that the past shall be forgotten, and the future shall hold no worries... An outlook on life that allows you to retain your high spirits.</p>
        ...
        <p>You see, your arhectype's aura is one that's bright, and radiant. Your laughter is infectious, and you're simply the person that everyone wants to be around.</p>
        
        <p>But there are obstacles that stand before you... Obstacles that you must be made aware of...</p>
        
        <h2 class="sub-header">Unfortunately, Not All Is Smooth-Sailing For The Notorious Jester, <span class="cap"><?php echo $name;?></span>... These Are The Shortcomings You Must Look Out For.</h2>
        ...
        <p>However, I have no doubt that with your strengths and personality traits, , you will overcome all that stands in your way, <span class="cap"><?php echo $name;?></span>.</p>
        ...
        <p>As a Jester, it is vital for you to get in touch with your more serious side. That will be quintessential to your development as an all-rounded, balanced, and emotionally connected individual.</p> 
        
        <p>This is the first step towards learning to open yourself up to others, <span class="cap"><?php echo $name;?></span>, and in that process, you will learn to trust as well as earn the trust of others.</p>
        ...
        <h2 class="sub-header"><span class="cap"><?php echo $name;?></span>, As A Jester, This Is Your Calling... And It's Beyond Your Wildest Imaginations</h2>
        ...
        <p><span class="cap"><?php echo $name;?></span>, there is power in positivity. There is great things to be learned from optimism - it's a form of energy in itself that has the potential to grant you fortitude and resilience... To weather out your potential challenges and difficulties. Embracing that will form a significant part of your calling in life.</p>

        <h2 class="sub-header">Here's A Glimpse Into Your Love Compatibility With Other Archetypes...</h2>

        <img class="love-img" src="../assets/img/love/jester-love-compatibility.png">
        ...
        <p><span class="cap"><?php echo $name;?></span>, the Jester archetype is known to be sensible, joyful, and fun in a relationship... You can, however, be a little bit indecisive at times.</p>
        ...
        <p>That lack of a connection is usually what does it in for you. But as long as you're willing to and continue to work on that, there is no doubt that a rewarding romantic life will be waiting right around the corner for you - perhaps in the form of your current partner, or a potential suitor.</p>
        ...
        <p>In the presence of your partner, you're not afraid of embracing who you are and expressing your true, playful self. As forementioned though, that is merely one aspect of your identity. It would not be possible to paint an entire picture with a single brush. Remember to embrace the different parts of yourself, and never be afraid to reveal them to your partner.</p>
