        <h2 class="sub-header"><span class="cap"><?php echo $name;?></span>, You Are The Member - And This Is What It Means...</h2>

        <p><span class="cap"><?php echo $name;?></span>, the Member archetype is one of the most interesting and contributing archetypes in society... Essentially, the Members are the ones who form the building blocks of the world... The ones who subscribe and participate in great causes.</p>
        ...
        <img class="img-intext" src="../assets/img/icons/member.png">

        <p>As a Member, you're able to earn the trust of others with your transparency. Unlike other archetypes, you're not afraid to bare it all and prove to others that your intentions are genuine.</p>
        ...
        <p><span class="cap"><?php echo $name;?></span>, this puts you at a great advantage when it comes to meeting and building relationships with people who can help you grow.</p>
        ...
        <p>You tend to make an excellent listener, <span class="cap"><?php echo $name;?></span>... You offer valuable input about tricky situations and disputes between others. That trait is emanated by your principled stance, morals, and ethics.</p>
        ...
        <p><span class="cap"><?php echo $name;?></span>, you are trustworthy, accepting, and conscientious.</p>
        ...
        <p>You do however, prefer to keep your circle of friends on the smaller side, <span class="cap"><?php echo $name;?></span>... Perhaps there's only a select number of people that you choose to spend most of your time with.
        ...
        <p><span class="cap"><?php echo $name;?></span>, there are traits of profound leadership that are hidden within you - hidden because they have yet to be fully explored and cultivated. You're able to rally support, and compel people to believe in your cause.</p>
        
        <p>But there are obstacles that stand before you... Obstacles that you must be made aware of...</p>
        
        <h2 class="sub-header">Unfortunately, Not All Is Smooth-Sailing For The Magnanimous Member, <span class="cap"><?php echo $name;?></span>... These Are The Shortcomings You Must Look Out For.</h2>
        ...
        <p><span class="cap"><?php echo $name;?></span>, as a Member, you've grown used to listening to other people's problems that you become a bit more reserved when it comes to talking about your own.</p>
        ...
        <p>You must forego the limiting belief thatlistening is all it takes, and be more open about sharing your personal circumstances and your ideas.</p>
        ...
        <p><span class="cap"><?php echo $name;?></span>, it's important to understand that all archetypes has its fair share of weaknesses and challenges. Now that you're aware of them, you'll be able to pay attention to them, and then improve on them.</p>

        <h2 class="sub-header">s A Member, This Is Your Calling... And It's Beyond Your Wildest Imaginations</h2>
        ...
        <p>Those personal strengths of your indicate something into your personality profile, <span class="cap"><?php echo $name;?></span>... They indicate that you will uncover fulfillment and joy from being active in a people-oriented role that will require you to do the things that you do best - influence, persuade, and motivate.</p>
        ...
        <img class="love-img" src="../assets/img/love/member-love-compatibility.png">
        ...
        <p><span class="cap"><?php echo $name;?></span>, the Member archetype is known to be sweet, attentive, and emotionally available in a relationship... You're thoughtful and courteous  - attributes than any potential suitor would appreciate.</p>
