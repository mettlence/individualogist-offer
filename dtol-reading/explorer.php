        <h2 class="sub-header"><span class="cap"><?php echo $name;?></span>, You Are The Explorer - And This Is What It Means...</h2>
        ...
        <p>You're a curious, and adventurous individual looking to make your mark on the world. You want to experience everything that the world has to offer - its magnificent lands, its foreign cultures, and its exciting opportunities.</p>

        <p>Based on your archetype, your biggest value in life is your sense of freedom. That's because as an Explorer, you're highly energetic, and you're always on the move. You tend to get bored with mundane and monotonus routines - and you're always looking for a way out.</p>
        ...
        <img class="img-intext" src="../assets/img/icons/explorer.png">

        <p>...Your archetype also suggests that you have the tendency to take action before thinking... But that does not mean to say that you're thoughtless - in fact, it's quite the contrary. You see, <span class="cap"><?php echo $name;?></span>, you recognize that thoughts tend to stand in the way of action. And what matters to you, is action.</p>
        ...
        <p>The Explorer archetype, <span class="cap"><?php echo $name;?></span>, is also one that strives to be different. You prefer to feel and immerse yourself in the most foreign environments - environments that the other archetypes would prefer to avoid.</p> 
        ...
        <p>That's why the world needs more people like you... I have no doubt that you will one day uncover ground-breaking discoveries, and contribute great things to the world.</p>
        ...
        <p><span class="cap"><?php echo $name;?></span>, despite often being the center of attention, your incessant curiosity about others makes you an individual who's self-aware and emotionally connected to others.</p> 
        ...
        <p>Although, there are times when compassion takes control over your tendencies, <span class="cap"><?php echo $name;?></span>... And that's when you become vulnerable to having your trust misplaced and taken advantage of.</p>
        ...
        <p>You see, you have a rather valiant aura, and a daring approach. You're not one to follow in the footsteps of others, are you, <span class="cap"><?php echo $name;?></span>.</p> 
        ...
        <h2 class="sub-header">Unfortunately, Not All Is Smooth-Sailing For The Adventurous Explorer, <span class="cap"><?php echo $name;?></span>... These Are The Shortcomings You Must Look Out For.</h2>
        ...
        <p>Despite your brave frontier, there are fears that reside within your archetype... Deep-seated fears that appear miniscule to others, but appear menacing to you.</p>

        <p>Your archetype tends to be fearful of commitment, and even anything that resembles it. <span class="cap"><?php echo $name;?></span>... It's likely that at a certain point in your life, you found the idea of marriage a little bit alien - an idea that just never made sense to you.</p> 
        ...
        <p>As an Explorer, <span class="cap"><?php echo $name;?></span>, you have the tendency to be a little too critical about yourself - constantly pushing yourself to achieve new heights, gain new experiences, and explore everywhere that you've never been before.</p> 
        ...
        <p>There's something else you need to be aware of, <span class="cap"><?php echo $name;?></span>.</p>
        ...
        <h2 class="sub-header"><span class="cap"><?php echo $name;?></span>, As An Explorer, This Is Your Calling... And It's Beyond Your Wildest Imaginations</h2>
        ...
        <p>And that's where your calling resides, <span class="cap"><?php echo $name;?></span>. You want to live life for yourself, without appearing selfish.</p> 
        ...
        <img class="love-img" src="../assets/img/love/explorer-love-compatibility.png">
        ...
        <p><span class="cap"><?php echo $name;?></span>, your love compatibility profile is extraordinarily different from the other archetypes - and I'm sure some of your exes or current partner will agree with me on this.</p>
