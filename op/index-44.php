            ...
            <div class="container-fluid bg-black text-white">
                <div class="row">
                    <div class="sp-wrapper part4">
                            ...
                            <?php
                             if (empty($name)) {
                                echo "<a class='btn buy-button' href='http://op44.individua1.pay.clickbank.net/?cbskin=25048&cbfid=40745&cbtimer=68&vtid=$vtid'>Click Here To Claim Your<br>Etheric Prosperity Pyramid</a>";
                             } else {
                                echo "<a class='btn buy-button' href='http://op44.individua1.pay.clickbank.net/?cbskin=25048&cbfid=40745&cbtimer=68&name=$name&email=$email&vtid=$vtid'>Click Here To Claim Your<br>Etheric Prosperity Pyramid</a>";
                             }
                            ?>

                            <p class="smallprint">Lock in your discount now and claim your LIMITED Etheric Prosperity Pyramid for just $44.90!</p>
                    </div>
                    </div>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="sp-wrapper part5">
                            ...
                            <p>Take this prosperity tool for $44.90 now (with free shipping) - because you will NEVER HAVE AN OPPORTUNITY like this AGAIN!</p>
                            ...
                            <ul class="ul-crystal">
                                ...
                                <li>You can receive it at its COST PRICE of just $44.90</li>
                            ...
                            <p>You can experience a divine transformation across your entire being - by simply seizing your Etheric Prosperity Pyramid at COST for <strong>$44.90 RIGHT NOW.</strong></p>
