...
<div class="container-fluid bg dgp-header">
    ...
    <div class="row">
        <div class="col-sm-8 mx-auto text-center">
            ...
            <h1 class="hero-h1"><span class="gold">FOR TODAY ONLY:</span> We’ll Send You This <span class="gold">Divine Guidance Pendulum</span>, Charged With Moonlight Energies - FREE</h1>
...
<div class="salespage-start part1">
    ...
    <div class="container">
        <div class="row">
            <div class="sp-wrapper">
                ...
                <p class="text-center"><strong>Connecting With The Divine Using The Same "Miracle Pendulum"</strong></p>
            </div>
        </div>
    </div>
    <div class="part2">
        <div class="container">
            <div class="row">
                <div class="sp-wrapper mx-auto">
                    ...
                    <p>Common pendulums derive answers from YOUR physical energies... But truly reliable guidance resides in our deeper soul-level energies.</p>
                </div>
            </div>
        </div>
    </div>
    <div class="container">
        <div class="row">
            <div class="sp-wrapper part3">
                ...
                <p><em>…Am I living according to my life purpose?</em></p>
    ...
    <div class="container">
        <div class="row">
            <div class="sp-wrapper">
                ...
                <a class="buy-button" href="#order-now">Claim My Free Pendulum <i class="fas fa-arrow-right"></i></a>
    ...
    <div class="container">
        <div class="row">
            <div class="sp-wrapper part4">
                ...
                <p>Each pendulum is also <strong>charged in the moonlight of a full moon for 24 hours.</strong></p>
                ...
                <p class="count-alert">Low Stock Alert: 76 pieces left</p>
                <a class="buy-button" href="#order-now">Claim My Free Pendulum <i class="fas fa-arrow-right"></i></a>
                <p class="buy-text"><strike>Retail Price: $49.00</strike> Today: $0.00</p>
                <img class="payment-options" src="/offer/paa/img/payment-options.png">
            </div>
        </div>
    </div>
    ...
    <div class="container mt-3" id="order-now">
        <div class="row">
            <div class="col-sm-5 mx-auto  my-auto">
            ...
            <div class="col-sm-7 mx-auto my-auto">
                <div class="cta-wrapper">
                    ...
                    <div class="cta-title">
                        Claim Your FREE Divine Guidance Pendulum
                        <p class="cta-small text-center">(Just Pay $14.90 Shipping)</p>
                    </div>
                    <div class="cta-content">
                        <ul class="tick-list">
                            <li><strong><strike>$49</strike> $0.00</strong> Divine Guide Pendulum</li>
                            <li><strong><strike>$27</strike> $0.00</strong> Pendulum Activation Guide</li>
                            <li><strong>Expedited</strong> Shipping ($14.90)</li>
                            <li><strong>60-Day</strong> Moneyback Guarantee</li>
                            <li><strong>I agree to</strong> only use my Divine Guidance Pendulum for good</li>
                        </ul>
                    </div>
                    <a class="buy-button" href="http://dgp.individua1.pay.clickbank.net/?cbskin=28290&cbfid=48914" id="buy-button">Yes, Please Rush My Free Pendulum Now <i class="fas fa-arrow-right"></i></a>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="faq-wrapper col-sm-8 mx-auto">
                ...
                <p>The Divine Guidance Pendulum normally retails for $49 (excluding shipping). If you include shipping, customers normally pay about $64. Good news is we're running a very special offer for TODAY ONLY, that's only available to the Divine Tarot Community. Members of our community can receive the Divine Guidance Pendulum at NO cost. Just cover shipping and handling for $14.90. As soon as our stocks run out, this special offer will be closed permanently.</p>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#buy-button').attr('href', 'http://dgp.individua1.pay.clickbank.net/?cbskin=28290&cbfid=48914&name=' + (getUrlParameter('name') != false ? getUrlParameter('name') : '') + '&email=' + (getUrlParameter('email') != false ? getUrlParameter('email') : ''))
    })
