...
<div class="container-fluid bg dgp-header">
    ...
    <div class="row">
        <div class="col-sm-8 mx-auto text-center">
            <p class="welcome-title">Welcome To The Divine Community, <span class="gold"><span class="name">Spiritual Seeker</span></span> - Please Accept This <span class="gold">FREE Gift</span>:</p>
            <h4 class="hero-h4">A <span class="gold">Miracle Moonlight-Charged Pendulum</span> For More</h4>
            <h1 class="hero-h1"><span class="gold">Love, Wisdom, Wealth, and Healing</span></h1>
<!--            <img class="dgp-faded d-none d-md-block" src="http://individualogist.com/offer/assets/img/dgp-faded.png">-->
        </div>
    </div>
</div>
        ...
        <div class="col-sm-7 mx-auto my-auto">
            <div class="cta-wrapper">
                ...
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="radio1">1 x Divine Guidance Pendulum <strong>(FREE + $14.90 Shipping)</strong></label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" id="radio2" name="radio-category" value="dgp-2" />
                    <label class="form-check-label" for="radio2"> 2 x Divine Guidance Pendulum <strong>(FREE + $19.90 Shipping)</strong></label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" id="radio3" name="radio-category" value="dgp-3" />
                    <label class="form-check-label" for="radio3">3 x Divine Guidance Pendulum <strong>(FREE + $29.90 Shipping)</strong></label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" id="radio4" name="radio-category" value="dgp-5" checked/>
                    <label class="form-check-label most-popular" for="radio4"><div class="red">BEST DEAL!</div>5 x Divine Guidance Pendulum <strong>(FREE + $49.90 Shipping)</strong></label>
                </div>
