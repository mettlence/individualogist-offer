...
<div class="dtol-container">
    ...
    <div class="dtol-header">
        <h1><span class="capitalize"><?php echo $_GET['name']; ?></span>, You Are About To Discover This One Secret Archetype Connecting You To All Other Forms Of Creation… The Physical Reality, And The Ethereal Dimension.</h1>
    </div>
...
<div id="cont-reading">
    <div class="dtol-reading">
        <p>Stay with me, <span class="capitalize"><?php echo $_GET['name']; ?></span>. Because I promise, you’re going to <span class="purple">like the answers</span> to those questions!</p>

        <p>And <span class="capitalize"><?php echo $_GET['name']; ?></span>, we’ve <span class="purple">unravelled the mysteries</span> behind this mystical archetype…</p>

        <div class="dtol-sub-header">
            <h2 class="purple">...Everything We've Uncovered Will Be Revealed To You, <span class="capitalize"><?php echo $_GET['name']; ?></span>. Right Here, Right Now.</h2>
        </div>

        <p><span class="capitalize"><?php echo $_GET['name']; ?></span>, when you requested your <span class="purple">Archetypal Reading,</span> it indicated that you’re more than ready for <span class="purple">great transformation</span> to take place in your life. You’re ready to pry open the <span class="purple">floodgates</span> of growth, healing, and abundance.</p>
        ...
        <p>Your archetype is deeply connected to the <span class="purple">Wise Old Man archetype</span> – an archetype that’s distinguished for its <span class="purple">astute judgments and intuitive wisdom.</span> That is a trait that’s present within you and your archetype, <span class="capitalize"><?php echo $_GET['name']; ?></span></p>
        ...
        <p><span class="capitalize"><?php echo $_GET['name']; ?></span>, this ‘legend’ is arguably the oldest, most widely dispersed, and most mysterious religious idea known to mankind. And yet, the concept, the idea <span class="purple">remains consistent</span> despite differing opinions, beliefs, and values.</p>
        ...
        <p><span class="capitalize"><?php echo $_GET['name']; ?></span>, I’m not just talking about a single aspect… I’m talking about <span class="purple">ALL aspects</span> of your life…</p>
        ...
        <p>You see, <span class="capitalize"><?php echo $_GET['name']; ?></span>, by attaining an understanding of this mythical archetype, and of the natural phenomenon that inspired it, you will receive the ultimate key to <span class="purple">decoding and eliminating all of your <span class="purple">spiritual enigmas, mental blockades, and physical limitations.</span></p>

        <div class="dtol-sub-header">
            <h2 class="purple">Receiving Wisdom, Fortune, And Abundance From The Tree Of Life</h2>
        </div>

        <p><span class="capitalize"><?php echo $_GET['name']; ?></span>, think of the Tree Of Life is an <span class="purple">infinite pool of energy</span> – a tree that constantly bears fruit for your personal consumption. And in this case, what you’ll be consuming is knowledge, wisdom, and growth.</p>
        ...
        <p>And let me tell you this, <span class="capitalize"><?php echo $_GET['name']; ?></span>, there is nothing in the world that’s more <span class="purple">rewarding</span> than seeing yourself become better and better every single day.</p>
        ...
        <p>Just like this tree, you too will <span class="purple">grow stronger over time</span> and strive for greater knowledge and newer experiences, <span class="capitalize"><?php echo $_GET['name']; ?></span>.</p>
        ...
        <div class="dtol-sub-header">
            <h2 class="purple"><span class="capitalize"><?php echo $_GET['name']; ?></span>, If Only You Could Imagine Just A Fraction Of What You'll Gain From The Divine Tree Of Life...</h2>
        </div>
...
<div id="cont2-reading">
    <div class="dtol-reading">
        <div class="dtol-sub-header">
            <h2 class="purple"><span class="capitalize"><?php echo $_GET['name']; ?></span>, If You Refrain From Embracing The Divine Tree Of Life...</h2>
        </div>
        ...
        <p>If you don’t commit yourself to change right now, then when? There is no perfect time to take action, friend. All spiritual teachers, religious leaders, and successful millionaires will agree with me on this – there is <span class="purple">no better time than now.</span></p>
        ...
        <div class="dtol-sub-header">
            <h2 class="purple"><span class="capitalize"><?php echo $_GET['name']; ?></span>, Here Is Everything That You Will Gain From This Program...</h2>
        </div>
...
<?php
$path = $_SERVER['DOCUMENT_ROOT'];
$path .= ('/clickbank/assets/inc/dtol-order.php');
include($path);
?>
    
    <div class="dtol-reading">
        <div class="dtol-sub-header">
            <h2 class="purple"><span class="capitalize"><?php echo $_GET['name']; ?></span>, We're Adding New Modules To The Divine Tree Of Life Every Month...</h2>
        </div>
        ...
        <p>The Divine Tree Of Life is a <span class="purple">timeless</span> program. Timeless, because there is no estimated duration. Timeless, because its secrets can be applied before, now, and after. Timeless, because that’s exactly how you’ll feel as you go through it, <span class="capitalize"><?php echo $_GET['name']; ?></span>…</p>

        <div class="dtol-sub-header">
            <h2 class="purple"><span class="capitalize"><?php echo $_GET['name']; ?></span>, Here's Why It's Not Going To Be What You Think...</h2>
        </div>
        ...
        <div class="dtol-sub-header">
            <h2 class="purple"><span class="capitalize"><?php echo $_GET['name']; ?></span>, Your Divine Tree Of Life Journey Can Commence For Just $7...</h2>
        </div>

        <img class="img-intext" src="../assets/img/dtol-cover.png">

        <p><span class="purple">SEVEN DOLLARS,</span> <span class="capitalize"><?php echo $_GET['name']; ?></span>, that’s all it takes.</p>
...
?>
    ...
    <div class="dtol-reading">
        <div class="dtol-sub-header">
            <h2 class="purple">Why On Earth Are We Even Doing This? Here's Why, <span class="capitalize"><?php echo $_GET['name']; ?></span>...</h2>
        </div>
        ...
        <p>If you decide that it isn’t for you, you can cancel your membership at any time to avoid paying the membership fee of just $19 per month.</p>

        <p>…But remember, <span class="capitalize"><?php echo $_GET['name']; ?></span>, your Tree of Life Membership includes <span class="purple">weekly readings, predictions, and little knowledge nibbles</span> that will escalate your personal growth.</p>
        ...
        <div class="dtol-sub-header">
            <h2 class="purple">Be Warned, <span class="capitalize"><?php echo $_GET['name']; ?></span>... Do Not Make This Mistake.</h2>
        </div>
        ...
        <p>So, don’t give up on yourself, <span class="capitalize"><?php echo $_GET['name']; ?></span>. Because I’m not giving up on you. We’re <span class="purple">not giving up</span> on you.</p>
        ...
        <p>Now, <span class="capitalize"><?php echo $_GET['name']; ?></span>, you’re ready to move on to the <span class="purple">NEXT STEP.</span> All you have to do now is <span class="purple">click on the button below.</span></p>
    </div>
...
<?php
$path = $_SERVER['DOCUMENT_ROOT'];
$path .= ('/clickbank/common/footer.php');
include($path);
?>
