...
<style>
    .sac-header {width:100%;max-width:800px;background:#fff;color:#333;box-shadow:none;text-shadow:none;border-bottom:2px solid #8429c2;font-size:2em}
    .sac-reading {width:100%;max-width:800px;}
    .archetype-xl,.img-intext {filter:none}
    .img-intext{-webkit-box-reflect:below 0px -webkit-gradient(linear, left top, left bottom, from(transparent), color-stop(90%, transparent) , to(rgba(250, 250, 250, 0.1)))}
    .sac-sub-header {color:#8429c2;box-shadow:none;border: 2px solid #8429c2;margin:1em auto;font-family:'Raleway',sans-serif}
    .purple{color:#8429c2}
    .img-border{border-radius:1em}
    .order-details{box-shadow:none}
    .order-title{text-shadow:none}
    .cta-button{line-height:1em;text-transform:uppercase}
    .guarantee{box-shadow:0 5px 15px rgba(0,0,0,.15);border-radius:1em}
    .testimonial{border:2px solid #8429c2;border-radius:1em}
    .testimonial h3{color:#8429c2;font-family:'Raleway',sans-serif;font-weight:700}
    .testimonial img{box-shadow:none;margin-bottom:.5em}
    .accordion{color:#8429c2}
    .active, .accordion:hover{background-color:#8429c2;color:#fff}
    .panel{border-bottom:1px solid #8429c2}
    .panel p {padding:.5em}
    #faq-area{background:#fff}
    .bullet-purple{box-shadow:0 5px 15px rgba(0,0,0,.15);border-radius:1em;color:#8429c2;margin:1em auto}
    @media only screen and (max-width: 720px) {
        .img-intext{margin:1em auto}
    }
</style>
...
<div class="sac-container">
    ...
    <?php echo $_GET['archetype']; if(empty($_GET)) { echo 'Caregiver'; 
        ...
        <img class="img-intext img-border" src="../assets/img/sac1.png">
        ...
        <img class="img-intext img-border" src="../assets/img/sac2.png">
        ...
        <h2 class="sac-sub-header">“Without <span class="goldenrod">knowledge,</span> action is useless. And  without <span class="goldenrod">action,</span> knowledge is futile”</h2>
        ...
        <img class="img-intext img-border" src="../assets/img/sac3.png">
        ...
        <img class="img-intext img-border" src="../assets/img/sac4.png">    
...
<?php
$path = $_SERVER['DOCUMENT_ROOT'];
$path .= ('/offer/assets/inc/sac-order.php');
include($path);
?>
...
?>
    ...
    <div class="sac-reading">
        ...
        <div class="testimonial">
            <span class="archetype-xs caregiver"></span>
            ...
            <p>I've read the Introduction and followed my Affirmations many times now. Originally, I followed your program to the letter. On the second day of your Sacred Affirmations, I heaved a huge sigh of comfort and relief. The images and wordings took me straight home to my forest environment.</p> 
                    
            <p>Exactly this vision, I had lost at the age of six. To see exactly this familiar road now, constitutes a life changing and behavioural change for me. Each day, I opened up a new page. Any time I wanted to, I could go back to day 2. Yes, this image is sublimely comforting. You have some awesome professionals working at Individualogist! This program felt customized to me and I can believe that you are capable of customizing the program to each person; as your site promises. </p> 
