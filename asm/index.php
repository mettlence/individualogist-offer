...
<style>
    ...
    .bg-asm {
        background: url('/offer/assets/img/asm-bg.jpg');
        background-size: cover;
        background-repeat: no-repeat;
        background-position: center center;
        height: 100%;
...
<div class="container-fluid bg-asm pt-5 pb-10">
...
<div class="container-fluid sales-page text-light">
    ...
    <div class="row">
        <div class="col-sm-8 mx-auto">
            ...
            <p><strong>...Comes a dire, new beginning.</strong></p>
            ...
            <h2 class="sub-header white-border">Let me introduce you to The Man with the Golden Voice - Ted Williams.</h2>
            ...
            <div class="ted-story">
                ...
                <img class="ted" src="/offer/assets/img/ted-williams.jpg">
                ...
                <img class="ted" src="/offer/assets/img/ted-williams2.jpg">
                ...
                <p>Ted, consciously or not, had become aware of <strong><em>Ascension Shifting</em></strong>, and with this knowledge has a keen ability to align himself with the forces beyond our perception...</p>
                <p><strong>...LEVERAGING the Cosmos to HIS benefit!</strong></p>
            </div>
        </div>
    </div>
</div>
<div class="container-fluid text-light sales-page">
    <div class="overlay-v"></div>
    <div class="row">
        <div class="col-sm-8 mx-auto">
            <h2 class="sub-header">What Is Ascension Shifting?</h2>
            <div class="separator"></div>
            <img class="ascension" src="/offer/assets/img/ascension-shift.png">
            <p><?php if (empty($name)) {
                    echo 'Think about this';
                } else {
                    echo $name;
                }; ?>, imagine being able to compartmentalize and disassemble everything that comprises your existence...</p>
            ...
            <ul class="sun-list">
                <li>...Dramatic changes in mood from the day to day.</li>
                <li>...Drastic life changes in parts of their life from work, school, or in their relationships.</li>
                <li>...Having odd, and often very specific food cravings that are as random as they are sudden.</li>
                <li>...Random foreboding or restlessness in anticipation of something significant.</li>
                <li>...Sporadic bursts of energy coursing through your body.</li>
                <li>...Finding some sort of resonance in their life that they want to attune themselves towards.</li>
            </ul>
            <p>Consider the story of Debra, age 32 - a promising young woman who wrote in to share her experience.</p>
...
<div class="container-fluid text-light cosmic-touch">
    <div class="overlay-v"></div>
    <div class="row">
        <div class="col-sm-8 mx-auto">
            ...
            <p><em>...But what about you?</em></p>
            <p>Did you stumble upon this message because you&rsquo;ve witnessed <em>similar signs?</em></p>
            <p>Do you have <em>restless moments</em> where you want to do something, but don&rsquo;t know where to even begin?</p>
            <p>Have you experienced a <em>moment of weakness</em> that took something out of you?</p>
...
<div class="container-fluid sales-page text-light mx-auto">
    <div class="row">
        <div class="col-sm-8 mx-auto">
            <h2 class="sub-header">Our Newest Discovery: Ascension Shift Mastery</h2>
            <div class="separator"></div>
...
<div class="container-fluid sales-page text-light mx-auto">
    <div class="row">
        <div class="col-sm-8 mx-auto">
            <h2 class="sub-header white-border">8 Powerful Modules To Ascension Shift Your Way To An Abundant Transformation</h2>
            <div class="whiteline"></div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-8 mx-auto">
            ...
            <div class="separator"></div>
            <p>Coincidences happen, but your reading of this message is far from coincidence, <?php if (empty($name)) {
                                                                                                    echo 'my dear';
                                                                                                } else {
                                                                                                    echo $name;
                                                                                                }; ?>.</p>
            ...
            <p>With all these factors already in place, you're right at the brink of your biggest breakthrough <?php if (empty($name)) {
                                                                                                                    echo 'yet';
                                                                                                                } else {
                                                                                                                    echo $name;
                                                                                                                }; ?>!</p>
            <h2 class="sub-header">Do Not Miss Your Golden Hour Of Abundance, Fulfillment, and Transformation</h2>
            <div class="separator"></div>
...
<div class="container-fluid sales-page text-light mx-auto">
    <div class="row">
        <div class="col-sm-8 mx-auto">
            ...
            <div class="separator"></div>
            <img src="/offer/paa/img/guarantee.png" style="text-align: center; display:block; margin: 0 auto; position: relative">
            ...
            <div class="separator"></div>
            <ul class="sun-list">
                <li>Become immune to negative influences and misguiding energies</li>
            ...
            <p><?php if (empty($name)) {
                    echo 'Fellow Ascension Seeker';
                } else {
                    echo $name;
                }; ?>, you can begin experiencing all the effortless abundance the Universe has to offer.</p>
            ...
            <p>It's time you became the bountiful, blessed, and revered <?php if (empty(archetype)) {
                                                                            echo 'individual';
                                                                        } else {
                                                                            echo $archetype;
                                                                        }; ?> you were meant to be.</p>
            <p class="text-center strong p-header">Seize the DECADE, <?php if (empty($name)) {
                                                                            echo 'dear one';
                                                                        } else {
                                                                            echo $name;
                                                                        }; ?>! Click on the button below now and gain INSTANT access to your Ascension Shift Mastery immediately!</p>
    ...
    if (email !== null) {
        $.ajax({
            ...
            success: function(responses) {
                ...
                $(".normal-link").attr('href', $('.cta-button').attr('href'));
                $(".token-notify").show();
            },
            error: function(err) {
                console.log(err);
