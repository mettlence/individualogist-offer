        <div id="archetype">
        <h2 class="sub-header"><span class="name cap">Friend</span>, You Are The Member - And This Is What It Means...</h2>
        ...
        <p><span class="name cap">Friend</span>, The Member archetype is one with that's exorbitantly talented in connecting and networking with others. You excel when it comes to making others feel comfortable, and creating links between people.</p>
        ...
        <p>Dear Member, you're able to earn the trust of others with your transparency. Unlike other archetypes, you're not afraid to bare it all and prove to others that your intentions are genuine.</p>
        ...
        <p>You tend to make an excellent listener, my dear... You offer valuable input about tricky situations and disputes between others. That trait is emanated by your principled stance, morals, and ethics.</p>
        ...
        <p><span class="name cap">Friend</span>, you are trustworthy, accepting, and conscientious.</p>
        ...
        <p><span class="name cap">Friend</span>, as a Member, you're realistic and modest when it comes to your goals. You prefer to take small steps, rather than large leaps - a more conservative approach that's both sound and sensible.</p>
        ...
        <h2 class="sub-header">Unfortunately, Not All Is Smooth-Sailing For The Magnanimous Member, <span class="name cap">Friend</span>... These Are The Shortcomings You Must Look Out For.</h2>
        ...
        <p>But that's also indicative of a deeper fear that resides within you... Specifically, the fear of rejection.</p>
        ...
        <p>But that could not be further from the truth, <span class="name cap">Friend</span>. People are almost always interested to know more about you, and that includes your frustrations, disappointments, and troubles.</p>
        ...
        <div id="calling">
        <h2 class="sub-header"><span class="name cap">Friend</span>, As A Member, This Is Your Calling... And It's Beyond Your Wildest Imaginations</h2>
        ...
        <p>Those personal strengths of your indicate something into your personality profile, <span class="name cap">Friend</span>... They indicate that you will uncover fulfillment and joy from being active in a people-oriented role that will require you to do the things that you do best - influence, persuade, and motivate.</p>
