        <div id="archetype">
        <h2 class="sub-header"><span class="name cap">Friend</span>, You Are The Innocent - And This Is What It Means...</h2>
        ...
        <p>Yes, <span class="name cap">Friend</span>...  The Innocent archetype is best defined by its sheer positivity, enthusiasim, and optimism. They're able to interpret any situation in a perspective that's hopeful, encouraging, and infectious. If you're thinking that there's a lot more to the Innocent archetype than just that, you're exactly right!</p>
        ...
        <p>That's why the world needs more people like you, <span class="name cap">Friend</span>... I have no doubt that you will one day infect others with your positivity, and influence them to have the same tenacity as you.</p>
        ...
        <p>You're far more magnanimous than others - always ready to give more than you're willing to receive. And that stems from your willingness to see the goodness in people.</p> 

        <p>In your eyes, all man is deserving of kindness - and that really translates through your actions.</p>

        <p><span class="name cap">Friend</span>, based on the strengths of your archetype, there is no doubt that you're an individual who makes a forgiving partner, a nurturing parent, and a dependable friend.</p>
        ...
        <p>Beyond that, <span class="name cap">Friend</span>, you have a profound understanding of the innerworkings of the human soul. Your empathtic nature allows you to comprehend what someone else is going through, and you always seem to know how to lead them out of darkness.</p> 

        <p>In many ways, you're the beacon of hope that has and will touch the lives of many.</p>

        <p>In terms of your behaviour around others, you're always ready to offer a listening ear. You're always swift to listen, but slow to speak. If you've ever wondered why people are always sharing their deepest troubles with you, that is the exact reason why.

        <p>You see, <span class="name cap">Friend</span> - you exude an aura of purity. You trust others just as easily as others are able to place their trust in you. That's because your earnestness really shows through your personality.</p>
            
        <p>But there are obstacles that stand before you... Obstacles that you must be made aware of...</p>
        
        <h2 class="sub-header">Unfortunately, Not All Is Smooth-Sailing For The Virtuous Innocent, <span class="name cap">Friend</span>... These Are The Shortcomings You Must Look Out For.</h2>
        ...
        <p>The Innocent archetype tends to struggle with coming out of its comfort zone. It's likely that you prefer to stay within the constrains of what you deem to be familiar. You must know, <span class="name cap">Friend</span>, with your strengths and unique talents, you are definitely capable of more than you could ever imagine.</p>

        <p>You see, as an Innocent, it is vital for you to take up the challenge of stepping out of your comfort zone. Being surrounded with unfamiliarity will allow room for you, as an Innocent, to develop and improve yourself. It does not have to toe the lines of extremeities - just small, little, progressive steps.</p>
        ...
        <p>Perhaps that might be why you concern yourself so much with the familiar... Because beyond the familiar, you're afraid that you'll lose your self-construed identity. That is perhaps, the greatest challenge that you must overcome, <span class="name cap">Friend</span>.</p>
        ...
        <div id="calling">
        <h2 class="sub-header"><span class="name cap">Friend</span>, As An Innocent, This Is Your Calling... And It's Beyond Your Wildest Imaginations</h2>
        ...
        <p>The chart above represents the archetypes that you’re most likely to end up with. Or if you’re already in a committed relationship, there’s a really good chance that your spouse is one of those archetypes.</p>

        <p><span class="name cap">Friend</span>, the Innocent archetype is known to be sweet, kind, and accepting in a relationship... It's unlikely that you will encounter much difficulty with finding potential suitors.</p>
        ...
        <p>It might take a while before you find the right one, <span class="name cap">Friend</span> - but as the saying goes, good things come to those who wait. If you're not in a committed relationship, your best bet will be to exercise patience and caution during your search for a romantic partner.</p>
