    ...
    $(document).ready(function() {
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          $(`.${response.data.archetype}`).css('display', 'block');
          $('.name').text(response.data.name);
          $('.archetype').text(response.data.archetype);
          $('#archetype-img').append('<img src=https://individualogist.com/offer/paa/img/icons/' + response.data.archetype + '.png/>')
          $(function() {
            $(".step1-reading").show();
            $(".step2-reading").hide();
            $(".step3-reading").hide();
