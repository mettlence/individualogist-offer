  ...
  <h2 class="faq-header">Q1. Will I really experience a transformation with this?</h2>
    ...
    <h2 class="faq-header">Q2. How will I receive my analysis?</h2>
        <div class="faq-para">
            ...
            <p>In the rare occasion where you do encounter issues with accessing your analysis, simply drop us an e-mail at contact@individualogist.com and our rockstar support team will assist you accordingly!</p>
        </div>
    ...
    <h2 class="faq-header">Q5. How does the moneyback guarantee work?</h2>
      <div class="faq-para">
        ...
        <p>If not, simply get in touch with us at contact@individualogist.com, and we'll issue you a FULL refund. No questions asked.</p>
          
        <p>In fact, you'll even GET to keep the bonuses for FREE - as a gesture of goodwill from all of us at Individualogist.com, to YOU, <?php echo $name;?>.</p>
