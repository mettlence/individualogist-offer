        ...
        <p>...Your archetype also suggests that you have the tendency to take action before thinking... But that does not mean to say that you're thoughtless - in fact, it's quite the contrary. You see, <span class="cap"><?php echo $_GET['name']; ?></span>, you recognize that thoughts tend to stand in the way of action. And what matters to you, is action.</p>
        ...
        <p>The Explorer archetype, <span class="cap"><?php echo $_GET['name']; ?></span>, is also one that strives to be different. You prefer to feel and immerse yourself in the most foreign environments - environments that the other archetypes would prefer to avoid.</p> 
        ...
        <p><span class="cap"><?php echo $_GET['name']; ?></span>, despite often being the center of attention, your incessant curiosity about others makes you an individual who's self-aware and emotionally connected to others.</p> 
        ...
        <p>You see, you have a rather valiant aura, and a daring approach. You're not one to follow in the footsteps of others, are you, <span class="cap"><?php echo $_GET['name']; ?></span>.</p> 
    ...
    <div id="cont-reading">
        ...
        <h2 class="sub-header">Unfortunately, Not All Is Smooth-Sailing For The Adventurous Explorer, <span class="cap"><?php echo $_GET['name']; ?></span>... These Are The Shortcomings You Must Look Out For.</h2>
        ...
        <p>Your archetype tends to be fearful of commitment, and even anything that resembles it. <span class="cap"><?php echo $_GET['name']; ?></span>... It's likely that at a certain point in your life, you found the idea of marriage a little bit alien - an idea that just never made sense to you.</p> 
        ...
        <p>As an Explorer, <span class="cap"><?php echo $_GET['name']; ?></span>, you have the tendency to be a little too critical about yourself - constantly pushing yourself to achieve new heights, gain new experiences, and explore everywhere that you've never been before.</p> 
        ...
        <h2 class="sub-header"><span class="cap"><?php echo $_GET['name']; ?></span>, As An Explorer, This Is Your Calling... And It's Beyond Your Wildest Imaginations</h2>
        ...
        <p>And that's where your calling resides, <span class="cap"><?php echo $_GET['name']; ?></span>. You want to live life for yourself, without appearing selfish.</p> 
