        <h2 class="sub-header"><span class="cap"><?php echo $_GET['name']; ?></span>, You Are The Hero - And This Is What It Means...</h2>
        ...
        <p>You might not be aware of this, <span class="cap"><?php echo $_GET['name']; ?></span>... But your willingness to step up to the plate is inspiring and encouraging to the people around you - strangers, friends, and loved ones. And because of this, your archetype truly has the capacity to achieve greatness.</p>
        ...
        <p><span class="cap"><?php echo $_GET['name']; ?></span>, it's become abundantly clear that you'll experience the greatest amount of fulfillment and joy from pursuing a career that will allow you to make difficult decisions, and give you a strong sense of duty...</p>
        ...
        <p>You see, <span class="cap"><?php echo $_GET['name']; ?></span> - you have a rather intense aura. That does not mean to say that it's a bad thing - after all, when it comes to getting things done, you'll always be on the top of everyone's lists.</p>
    ...
    <div id="cont-reading">
        <h2 class="sub-header">Unfortunately, Not All Is Smooth-Sailing For The Courageous Hero, <span class="cap"><?php echo $_GET['name']; ?></span>... These Are The Shortcomings You Must Look Out For.</h2>
        ...
        <p>Perhaps that might be why you concern yourself so much with appearances... Because without appearances, you're afraid that you'll lose your self-construed identity. That is perhaps, the greatest challenge that you must overcome, <span class="cap"><?php echo $_GET['name']; ?></span></p>
        ...
        <p>After all, this is the Hero's motto... When there's a will, there's a way. And that saying really shines through your actions and behaviour, <span class="cap"><?php echo $_GET['name']; ?></span>.</p>

        <h2 class="sub-header">As A Hero, This Is Your Calling... And It's Beyond Your Wildest Imaginations</h2>

        <p><span class="cap"><?php echo $_GET['name']; ?></span>, ultimately, you are a realist – someone who sets and achieves realistic goals. You're not comfortable with being wishy-washy or fickle-minded. When you've set your mind to something, you'll do everything it takes to make it happen.</p>
