        <h2 class="sub-header"><span class="cap"><?php echo $_GET['name']; ?></span>, You Are The Lover - And This Is What It Means...</h2>
        ...
        <p>And as you might have already guessed by now, even though you draw energy from being by yourself, you're a lot more people-oriented that you think, <span class="cap"><?php echo $_GET['name']; ?></span>
    ...
    <div id="cont-reading">
        <h2 class="sub-header">Unfortunately, Not All Is Smooth-Sailing For The Romantic Lover, <span class="cap"><?php echo $_GET['name']; ?></span>... These Are The Shortcomings You Must Look Out For.</h2>
        ...
        <h2 class="sub-header"><span class="cap"><?php echo $_GET['name']; ?></span>, As A Lover, This Is Your Calling... And It's Beyond Your Wildest Imaginations</h2>
