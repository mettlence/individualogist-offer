        <h2 class="sub-header"><span class="cap"><?php echo $_GET['name']; ?></span>, You Are The Jester - And This Is What It Means...</h2>

        <p><span class="cap"><?php echo $_GET['name']; ?></span>, before you dismiss this Archetypal Introduction as nothing but hogwash, you must know that the Jester archetype is NOT one that's solely represented as a mere joker.</p> 
        ...
        <p>People find themselves drawn to you because of your ability to spice up your conversations. And all of that just seems to come naturally to you, doesn't it, <span class="cap"><?php echo $_GET['name']; ?></span>? Your personable body language and outgoing attitude towards in life makes you a sheer joy to be around.</p>
        ...
        <p><span class="cap"><?php echo $_GET['name']; ?></span>, you are an individual who's impressionable, cheerful, and intriguing. You seem to be able to blend into any social group, and you have a wide circle of friends.</p> 
        ...
        <p><span class="cap"><?php echo $_GET['name']; ?></span>, as a Jester, you center your life around one thing - living in the present. You live life according to your own rules, and that states that the past shall be forgotten, and the future shall hold no worries... An outlook on life that allows you to retain your high spirits.</p>
    ...
    <div id="cont-reading">
        <h2 class="sub-header">Unfortunately, Not All Is Smooth-Sailing For The Notorious Jester, <span class="cap"><?php echo $_GET['name']; ?></span>... These Are The Shortcomings You Must Look Out For.</h2>
        ...
        <p>However, I have no doubt that with your strengths and personality traits, , you will overcome all that stands in your way, <span class="cap"><?php echo $_GET['name']; ?></span>.</p>
        ...
        <p>This is the first step towards learning to open yourself up to others, <span class="cap"><?php echo $_GET['name']; ?></span>, and in that process, you will learn to trust as well as earn the trust of others.</p>
        ...
        <h2 class="sub-header"><span class="cap"><?php echo $_GET['name']; ?></span>, As A Jester, This Is Your Calling... And It's Beyond Your Wildest Imaginations</h2>
        ...
        <p><span class="cap"><?php echo $_GET['name']; ?></span>, there is power in positivity. There is great things to be learned from optimism - it's a form of energy in itself that has the potential to grant you fortitude and resilience... To weather out your potential challenges and difficulties. Embracing that will form a significant part of your calling in life.</p>
        ...
        <p><span class="cap"><?php echo $_GET['name']; ?></span>, the Jester archetype is known to be sensible, joyful, and fun in a relationship... You can, however, be a little bit indecisive at times.</p>
