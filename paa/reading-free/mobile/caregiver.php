    ...
    <div class="step3-reading">
        <h2 class="sub-header">Unfortunately, Not All Is Smooth-Sailing For The Magnanimous Caregiver, <?php echo $_GET['name']; ?>... These Are The Shortcomings You Must Look Out For.</h2>
