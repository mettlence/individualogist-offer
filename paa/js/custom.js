...
function personalize() {
    ...
    var archetypeImg = document.getElementsByClassName('archetype-img');
    ...
    for (i=0; i<archetypeImg.length; i++) {
        archetypeImg[i].innerHTML = "<img src='../img/icons/"+getCookie('logic_archetype').toLowerCase()+".png' width='100px'>";
    }
