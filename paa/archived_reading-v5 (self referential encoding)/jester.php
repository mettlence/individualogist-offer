        ...
        <p>Others might perceive you to be an individual who's more emotional because of your spontaneity... But, you are in fact, more intuitive and perceptive than you make yourself out to be. After all, <span class="cap"><?php echo $_GET['name']; ?></span>, your excellent sense of humour is constructed with creativity, and seasoned with your charisma. And that requires a certain calibre of incisiveness.</p>
        ...
        <p>You might not like to admit it, <span class="cap"><?php echo $_GET['name']; ?></span>... But you tend to waiver a bit when it comes to serious situations or harsh conversations. You'd very much rather avoid such instances entirely, instead of having to actually deal with them. That is a struggle that you must be careful of. But we'll speak more to that later.</p>
        ...
        <p>You are an individual that's impressionable, cheerful, and intriguing. You seem to be able to blend into any social group, and you have a wide circle of friends.</p> 
        ...
        <p>There's something else about your archetype, <span class="cap"><?php echo $_GET['name']; ?></span>... Nothing pleases you more than experiencing the joys and emotions of life at its maximum. In the face of adversity, you're somehow able to move past setbacks quickly, and effortlessly.</p>

        <p><span class="cap"><?php echo $_GET['name']; ?></span>, based on the strengths of your archetype, nothing seems to be able to put you down - or not for long, to say the least.</p>
...
<!--        <button class="step-btn step2">Click Here To Discover What These Obstacles Are</button>-->
    ...
    <div class="step2-reading">
        ...
        <p>In the presence of your partner, you're not afraid of embracing who you are and expressing your true, playful self. But that is merely one aspect of your identity. It would not be possible to paint an entire picture with a single brush. Remember to embrace the different parts of yourself, and never be afraid to reveal them to your partner.</p>
