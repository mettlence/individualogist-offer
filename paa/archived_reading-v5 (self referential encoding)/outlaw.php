        ...
        <p><span class="cap"><?php echo $_GET['name']; ?></span>, you are passionate, extreme, and authentic.</p>
        ...
        <p>Apart from that, you're also an individual that's altruistic and charitable. You rarely shy away from opportunities to give - as long as you know that the causes you give to are causes that you truly believe in.</p>
...
<!--        <button class="step-btn step2">Click Here To Discover What These Obstacles Are</button>-->
    ...
    <div class="step2-reading">
        ...
        <p>The Outlaw archetype tends to struggle with learning to trust others. And that often forces you to be cynical, skeptical, and suspicious of others' intentions.</p>
        ...
        <p><span class="cap"><?php echo $_GET['name']; ?></span>, that fear of yours originates from a deeper fear that resides within you... and that is your fear of being vulnerable.</p>
        ...
        <p><span class="cap"><?php echo $_GET['name']; ?></span>, you tend to gravitate towards relationships that are temporary and short-lived. You're fully committed during the duration that it lasts, but when the flame goes out, you're ready to move on.</p>
