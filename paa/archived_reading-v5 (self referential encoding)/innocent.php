        ...
        <p>You must know that the Innocent archetype is NOT one that's typically associated with naivety. Truth be told, it is anything but. If you'd like to find out the truth about what the Innocent really resembles, then please proceed with the rest of this Archetypal Introduction with an open mind, and a willing heart.</p>
        ...
        <p>To you, <span class="cap"><?php echo $_GET['name']; ?></span>, everyone has a story worth listening to, every circumstance holds something worth experiencing, and everything that happens in life,  happens for a reason. That is a belief; a deep-rooted outlook that makes the Innocent archetype so remarkable.</p>
        ...
        <p>There's something else about your archetype, <span class="cap"><?php echo $_GET['name']; ?></span>... You're far more magnanimous than others - always ready to  give more than you're willing to receive. And that stems from your willingness to see the goodness in people.</p> 
        ...
        <p>Beyond that, you have a profound understanding of the inner workings of the human soul. Your empathtic nature allows you to comprehend what someone else is going through, and you always seem to know how to lead them out of darkness.</p> 
...
<!--        <button class="step-btn step2">Click Here To Discover What These Obstacles Are</button>-->
        <button class="step-btn step2">Show Me Now</button>
    </div>
    ...
    <div class="step2-reading">
        ...
        <button class="step-btn step3">Yes, Reveal My Life Path!</button>
    </div>