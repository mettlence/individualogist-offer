...
<!--        <button class="step-btn step2">Click Here To Discover What These Obstacles Are</button>-->
    ...
    <div class="step2-reading">
        ...
        <p>Although you're always telling yourself not to care, there's a part of you that struggles to let go. And even though you manage to successfully convince yourself sometimes, you eventually fall back into the same patterns and same routines.</p>
        ...
        <h2 class="sub-header"><span class="cap"><?php echo $_GET['name']; ?></span>, As A Creator, This Is Your Calling... And It's Beyond Your Wildest Imaginations</h2>
