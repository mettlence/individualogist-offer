        ...
        <p>That being said, you truly are a unique individual, <span class="cap"><?php echo $_GET['name']; ?></span>... And needless to say, the world certainly needs more people like you.</p>
        ...
        <p>You might not be aware of this, <span class="cap"><?php echo $_GET['name']; ?></span>... But your generosity does not go unnoticed. In fact, it inspires and encourages literally everyone around you.</p>
