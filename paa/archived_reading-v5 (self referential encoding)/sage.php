        ...
        <p>Although, you do prefer to keep to yourself, and you're not always outspoken. You are, however, more than willing to provide others with answers and advice when prompted.</p>
    ...
    <div class="step2-reading">
        <h2 class="sub-header">Unfortunately, Not All Is Smooth-Sailing For The Wise Sage, <span class="cap"><?php echo $_GET['name']; ?></span>... These Are The Shortcomings You Must Look Out For.</h2>
