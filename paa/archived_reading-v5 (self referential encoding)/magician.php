        ...
        <p>You are intuitive, knowledgeable, and versatile. You have a wide variety of interests, but perhaps your greatest interest of all is learning.</p>
        ...
        <p><span class="cap"><?php echo $_GET['name']; ?></span>, based on the strengths of your archetype, you're an individual that's highly observant, and incredibly resourceful.</p>
...
<!--        <button class="step-btn step2">Click Here To Discover What These Obstacles Are</button>-->
    ...
    <div class="step2-reading">
        ...
        <p><span class="cap"><?php echo $_GET['name']; ?></span>, While others seem to find it difficult to even understand the fundamentals of a new skill, you’re able to attain mastery over anything you set your mind to. In a way, your greatest strength is your ability to learn.</p>
        ...
        <p><span class="cap"><?php echo $_GET['name']; ?></span>, the Magician archetype is known to be faithful, tender, and devoted in a relationship... You're giving and understanding - attributes than any lover would cherish.</p>

        <p>As much as you dislike to admit it, there is a strong yearning for romance that resides within you. And that's supported by your faithfulness and commitment in a relationship.</p>
