 <a href="http://test-upsell2.individua1.pay.clickbank.net/?cbur=a">Accept</a>
<a href="http://test-upsell2.individua1.pay.clickbank.net/?cbur=d">Decline</a>
...
<?php
    if(!empty($_GET['iv']) && !empty($_GET['params'])) {
        ...
        $productPrice = $json->totalAccountAmount;
