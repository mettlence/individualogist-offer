...
<style>
        ...
        <div class="salespage-start part1">
            <div class="container">
                <div class="row">
                    <div class="sp-wrapper">
                        <p><strong>Dear <span class="name">Truth Seeker</span>,</strong></p>
            ...
            <div class="container-fluid bg meditateneon">
                ...
                <div class="row">
                    <div class="col-sm-8 mx-auto">
                        <p class="text-center strong">You're doing the exact opposite, <span class="name">my dear</span>! You're actually EXPENDING your precious, positive energy, attempting to create something that physically and spiritually CANNOT be created!</p>
            ...
            <div class="container-fluid bg-black text-white">
                <div class="row">
                    <div class="sp-wrapper part4">
                        ...
                        <p><span class="name">Fellow truth seeker</span>, Your Energy Transfiguration Sphere holds the answer to protecting you from negative energies, aligning your chakras, and becoming the abundant and enlightened individual you were always meant to be.</p>
                        ...
                        <p>Normally, I charge strangers a very fair price of a little over $200 (excluding shipping) for a single piece of the Energy Transfiguration Sphere. Including shipping and handling, it would be somewhere around $220 to $230.</p>
                        ...
                        <p>I'm going to give you your Energy Transfiguration Sphere at a CONSIDERABLE DISCOUNT.</p>
                        <p class="text-center strong">For just $59.90, you can receive your Energy Transfiguration Sphere right at your doorstep!</p>
                        ...
                        <a class="btn buy-button">Yes, Send Me My <br>Energy Transfiguration Sphere!</a>


                        <p class="smallprint">Lock in your discount now and claim your LIMITED Energy Transfiguration Sphere for just $59.90!</p>
                    </div>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="sp-wrapper part5">
                        ...
                        <ul class="ul-crystal">
                            ...
                            <li>You can receive it on discount for just $59.90</li>
                        ...
                        <p>You can experience a divine transformation across your entire being - by simply seizing your Energy Transformation Sphere at a DISCOUNT for <strike>$200</strike> <strong>$59.90 RIGHT NOW.</strong></p>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="quote-card">
                            ...
                            <p class="small text-center">Results experienced are not typical. Your results may vary.</p>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="quote-card">
            ...
            <div class="container-fluid bg-black text-white">
                <div class="row">
                    <div class="faq-wrapper col-sm-8 mx-auto">
                        ...
                        <p>Regardless of wherever you are in the world, I will have your Energy Transfiguration Sphere shipped straight to your doorstep <strong>for FREE.</strong> No hidden charges, and no other costs are incurred - I guarantee it. Take it as my token of love, appreciation, and sincere gratitude for being a valued member of the Individualogist.com community :)</p>
                        ...
                        <p>I get it - purchasing things online might not be something you're used to. Perhaps you're afraid that your parcel will get lost, or perhaps you're afraid that your energy transfiguration sphere is not going to work. That's exactly why you're 100% protected by my 60 day moneyback guarantee. All you have to do is send the sphere back to me within the next 60 days, and I'll refund your entire purchase.</p>
                        ...
                        <p>As you can tell, making just one of these by hand can be an extremely detailed and tiresome process. It's been an amazing journey, and I do sincerely hope that you'll be one of the fortunate ones to enjoy the fruits of our labour.</p>
                        <a class="btn buy-button">Yes, Send Me My <br>Energy Transfiguration Sphere!</a>
                        <p class="smallprint">Lock in your discount now and claim your LIMITED Energy Transfiguration Sphere for just $59.90!</p>
                    </div>
                </div>
    ...
    function getParameterByName( name ){
      ...
      if( results == null )
        ...
        var vtid = getParameterByName('utm_content');
        
        //set personalized values from cookies
        ...
        var cbUrl = '.individua1.pay.clickbank.net/?';
        var cbSku = 'ets';
        var cbSkin = 'cbskin=25048';
        var cbExit = 'cbexit=839';
        var cbFid = 'cbfid=38823';
        var cbTimer= 'cbtimer=68';
        var cbVtid = 'vtid=' + vtid;

    $('.buy-button').click(function() {
        $(this).attr('href', 'http://' + cbSku + cbUrl + cbSkin + '&' + cbExit + '&' + cbFid + '&' + cbTimer + '&' + cbVtid + '&' + 'name=' + getName + '&' + 'email=' + getEmail);
    });
    </script>
