...
<html lang="en">
  ...
  <head>
    ...
    <title>Energy Transfiguration Reading | Individualogist.com</title>
  ...
  <body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TGKFM45"
            ...
            <div class="container-fluid bg-black text-white">
                <div class="row">
                    <div class="sp-wrapper part4">
                        ...
                        <p>I'm going to give you your Energy Transfiguration Sphere AT COST.</p>
                        ...
                        <p>AND. We can only afford to give 50 pieces of this at $59.90.</p>
                        <p>As soon as we've hit the 50-piece limit, the price will revert BACK to $200 per sphere.</p>
                        <p>Which means, there's no guarantee that you'll be able to get your Energy Transfiguration Sphere at $59.90 in the next few hours.</p>
                        ...
                        <?php
                         if (empty($name)) {
                            echo "<a class='btn buy-button' href='http://ets.individua1.pay.clickbank.net/?cbskin=25048&cbexit=839&cbfid=38823&cbtimer=68&vtid=$vtid'>Click Here To Claim Your<br>Energy Transfiguration Sphere</a>";
                         } else {
                            echo "<a class='btn buy-button' href='http://ets.individua1.pay.clickbank.net/?cbskin=25048&cbexit=839&cbfid=38823&cbtimer=68&name=$name&email=$email&vtid=$vtid'>Click Here To Claim Your<br>Energy Transfiguration Sphere</a>";
                         }
                        ?>
                ...
                <div class="row">
                    <div class="sp-wrapper part5">
                        ...
                        <ul class="ul-crystal">
                            ...
                            <li>You can receive it at the COST PRICE of just $59.90</li>
                        ...
                        <p>You can experience a divine transformation across your entire being - by simply seizing your Energy Transformation Sphere at COST for <strike>$200</strike> <strong>$59.90 RIGHT NOW.</strong></p>
