<?php
$PageTitle = "Premium Daily Tarot (Free Trial) | Individualogist.com";
            ...
            <div class="container">
                <div class="row">
                    <div class="sp-wrapper">
                        ...
                        <p class="sp-title">Gain Instant Access To Your Premium Daily Tarot For FREE</p>
                        ...
                        <div class="order-form">
                            <h2 class="order-title">Yes! Claim My Premium Daily Tarot (7-Day Free Trial - Cancel Anytime)</h2>
                             
                            <?php
                             if (empty($name)) {
                                echo "<a class='btn buy-button' href='http://pdt-ft.individua1.pay.clickbank.net/?cbskin=25048&cbtimer=68&vtid=$vtid'>Yes! Add To My Order!</a>";
                             } else {
                                echo "<a class='btn buy-button' href='http://pdt-ft.individua1.pay.clickbank.net/?cbskin=25048&cbtimer=68&name=$name&email=$email&vtid=$vtid'>Yes! Add To My Order!</a>";
                             }
                            ?>
                            
                            <?php
                             if (empty($name)) {
                                echo "<a class='buy-link' href='http://pdt-ft.individua1.pay.clickbank.net/?cbskin=25048&cbtimer=68&vtid=$vtid'>Click Here To Claim Your Premium Daily Tarot!</a>";
                             } else {
                                echo "<a class='buy-link' href='http://pdt-ft.individua1.pay.clickbank.net/?cbskin=25048&cbtimer=68&name=$name&email=$email&vtid=$vtid'>Click Here To Claim Your Premium Daily Tarot!</a>";
                             }
                            ?>
